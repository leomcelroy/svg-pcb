...
board.wire(path(IC2.pad("gnd"),
                [IC2.padX("in"), IC2.padY("gnd")],
                [IC2.padX("in"), C1.padY("1")],
                C1.pad("1"),), w);

board.wire(path(IC2.pad("out"),
                [IC1.padX("RST")-.09, IC2.padY("out")],
                [IC1.padX("RST")-.09, C1.padY("2")],
                C1.pad("2"),), w);

board.wire(path(S1.pad("R2"),
                [S1.posX, S1.padY("R2")],), w);

board.wire(path(IC1.pad("A04"),
                [S1.padX("L2"), IC1.padY("A04")],
                S1.pad("L2"),), w);

board.wire(path(IC2.pad("gnd"),
                [IC2.padX("in"), IC2.padY("gnd")],
                [IC2.padX("in"), J1.padY("GND")-.1],
                [S1.posX, J1.padY("GND")-.1],
                [S1.posX, J2.padY("GND")-.11],
                [J2.padX("GND"), J2.padY("GND")-.11],
                J2.pad("GND"),), w);
