...
const ESP_01 = {"GND":{"shape":"M 0.0375,-0.0182L 0.0378,-0.0181L 0.039,-0.0176L 0.0403,-0.0169L 0.0408,-0.0165L 0.0414,-0.0162L 0.0431,-0.015L 0.044,-0.014L 0.0446,-0.0135L 0.045,-0.0131L 0.0454,-0.0125L 0.0467,-0.0109L 0.047,-0.0103L 0.0474,-0.0097L 0.0477,-0.0092L 0.048,-0.0086L 0.0483,-0.008L 0.0486,-0.0073L 0.0488,-0.0067L 0.049,-0.0061L 0.0493,-0.0054L 0.0494,-0.0047L 0.0496,-0.0041L 0.0497,-0.0034L 0.05,-0.0007L 0.05,0.0007L 0.0497,0.0034L 0.0496,0.0041L 0.0494,0.0047L 0.0493,0.0054L 0.049,0.0061L 0.0488,0.0067L 0.0486,0.0073L 0.0483,0.008L 0.048,0.0086L 0.0477,0.0092L 0.0474,0.0097L 0.047,0.0103L 0.0467,0.0109L 0.0454,0.0125L 0.045,0.0131L 0.0446,0.0135L 0.044,0.014L 0.0431,0.015L 0.0414,0.0162L 0.0408,0.0165L 0.0403,0.0169L 0.039,0.0176L 0.0378,0.0181L 0.0375,0.0182L 0.0375,0.02L -0.0375,0.02L -0.0375,-0.02L 0.0375,-0.02L 0.0375,-0.0182","pos":[0.1175,0.15],"layers":["F.Cu"],"index":1},"Tx":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[-0.1175,0.15],"layers":["F.Cu"],"index":2},"IO2":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[0.1175,0.05],"layers":["F.Cu"],"index":3},"EN":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[-0.1175,0.05],"layers":["F.Cu"],"index":4},"IO0":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[0.1175,-0.05],"layers":["F.Cu"],"index":5},"RST":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[-0.1175,-0.05],"layers":["F.Cu"],"index":6},"Rx":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[0.1175,-0.15],"layers":["F.Cu"],"index":7},"VCC":{"shape":"M -0.0375,0.02L 0.0375,0.02L 0.0375,-0.02L -0.0375,-0.02L -0.0375,0.02","pos":[-0.1175,-0.15],"layers":["F.Cu"],"index":8}};
...
/* -- ADD_COMPONENTS -- */
let J1 = board.add(header_FTDI, {translate: pt(x+width-.22, y+.48), rotate: 0, name: 'J1 serial\n5V power\n3.3V logic'});
...
let J2 = board.add(ESP_01, {translate: pt(IC1.posX-.49, IC1.posY), rotate: 180, name: 'J2\nESP-01'});
let R1 = board.add(R_1206, {translate: pt(J2.padX("EN")+.11, J2.padY("IO0")), rotate: 90, name: 'R1\n10k'});
let S1 = board.add(button_6mm, {translate: pt(J2.padX("GND")+.12, J2.padY("GND")-.2), name: 'S1\nreset'});
let S2 = board.add(slide_switch, {translate: pt(S1.posX, J2.padY("VCC")+.21), rotate: 180, name: 'S2\nprog run'});
let R2 = board.add(R_1206, {translate: pt(J2.padX("IO0")-.11, J2.padY("IO0")), rotate: 90, name: 'R2\n10k'});
...
board.wire([IC1.pad("G"),
            ...
            pt(IC1.padX("G")-.05, J1.padY("GND")+.07),
            pt(J1.padX("GND"), J1.padY("GND")+.07),
            J1.pad("GND")], w);
...
board.wire([R1.pad("1"),
            pt(R1.posX, J2.padY("EN")),
            J2.pad("EN")], w);

board.wire([R1.pad("2"),
            pt(R1.posX, J2.padY("VCC")),
            J2.pad("VCC")], w);

board.wire([J2.pad("GND"),
            pt(J2.posX, J2.padY("GND")),
            pt(J2.posX, J2.padY("GND")+.05),
            pt(R1.posX+.04, J2.padY("GND")+.05),
            pt(R1.posX+.04, C1.posY-.1),
            pt(J1.posX-.11, C1.posY-.1),
            pt(J1.posX-.11, J1.padY("VCC")-.05),
            pt(J1.posX+.09, J1.padY("VCC")-.05),
            pt(J1.posX+.09, J1.padY("GND")),
            J1.pad("GND")], w);

board.wire([J2.pad("Tx"),
            pt(R1.posX+.01, J2.padY("Tx")),
            pt(R1.posX+.01, C1.posY-.13),
            pt(J1.posX-.08, C1.posY-.13),
            pt(J1.posX-.08, J1.padY("Rx")),
            J1.pad("Rx")], w);

board.wire([J2.pad("Rx"),
            pt(J2.posX+.04, J2.padY("Rx")),
            pt(J2.posX+.04, J2.padY("Rx")+.05),
            pt(R1.posX, J2.padY("Rx")+.05),
            pt(R1.posX, J1.padY("GND")+.1),
            pt(J1.posX+.12, J1.padY("GND")+.1),
            pt(J1.posX+.12, J1.padY("Tx")),
            J1.pad("Tx")], w);

board.wire([J2.pad("VCC"),
            pt(R1.posX+.07, J2.padY("VCC")),
            pt(R1.posX+.07, C1.posY-.07),
            pt(C1.posX, C1.posY-.07),
            IC1.pad("O")], w);

board.wire([S1.pad("R1"),
            pt(J2.posX, S1.padY("R1")),
            pt(J2.posX, J2.padY("GND")),
            J2.pad("GND")], w);

board.wire([R2.pad("1"),
            pt(R2.posX, S1.padY("L1")),
            S1.pad("L1")], w);

board.wire([pt(R2.posX, J2.padY("RST")-.05),
            pt(J2.padX("RST"), J2.padY("RST")-.05),
            J2.pad("RST")], w);

board.wire([pt(R2.posX, J2.padY("VCC")-.05),
            pt(J2.padX("VCC"), J2.padY("VCC")-.05),
            J2.pad("VCC")], w);

board.wire([J2.pad("IO0"),
            pt(R2.posX-.07, J2.padY("IO0")),
            pt(R2.posX-.07, J2.padY("Rx")+.05),
            pt(S2.padX("2"), J2.padY("Rx")+.05),
            S2.pad("2")], w);

board.wire([S1.pad("R1"),
            pt(R2.posX-.1, S1.padY("R1")),
            pt(R2.posX-.1, S2.padY("3")),
            S2.pad("3")], w);
