...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.58, y+.39), name: 'IC1\nD11C'});
...
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A05")-.38, IC1.padY("A14")), rotate: -90, name: 'IC2\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC2.posX, IC2.posY-.2), rotate: 90, name: 'C1\n1uF'});
let C2 = board.add(C_1206, {translate: pt(C1.posX+.12, C1.posY), rotate: 90, name: 'C2\n.1uF'});
let R1 = board.add(R_1206, {translate: pt(C2.posX+.12, C2.posY), rotate: 90, name: 'R1\n10k'});
let R2 = board.add(R_1206, {translate: pt(R1.posX-.01, IC1.padY("A08")-.025), rotate: 90, name: 'R2\n1k'});
let LED1 = board.add(LED_1206, {translate: pt(C2.posX+.01, R2.posY), rotate: 90, name: 'LED1'});
...
board.wire([C1.pad("2"),
            ...
            pt(C1.posX-.06, J1.padY("GND")-.08),
            pt(IC1.padX("A04")+.1, J1.padY("GND")-.08),
            pt(IC1.padX("A04")+.1, J2.padY("GND")-.11),
            pt(J2.padX("GND"), J2.padY("GND")-.11),
            J2.pad("GND")], w);

board.wire([C2.pad("1"),
            pt(C2.posX, J1.padY("GND")-.08)], w);

board.wire([R1.pad("1"),
            pt(R1.posX-.06, R1.padY("1"))], w);
...
board.wire([J1.pad("RST"),
            pt(IC1.padX("RST")-.07, J1.padY("RST")),
            pt(IC1.padX("RST")-.07, R1.padY("2")),
            R1.pad("2")], w);

board.wire([C1.pad("1"),
            pt(C1.posX+.06, C1.padY("1")),
            pt(C1.posX+.06, C1.posY),
            pt(C2.posX+.06, C1.posY),
            pt(C2.posX+.06, J1.padY("GND")-.05),
            pt(IC1.padX("VDD")+.07, J1.padY("GND")-.05),
            pt(IC1.padX("VDD")+.07, IC1.padY("VDD")),
            IC1.pad("VDD")], w);

board.wire([IC1.pad("A05"),
            pt(R2.posX, IC1.padY("A05"))], w);
