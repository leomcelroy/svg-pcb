...
board.wire(path(IC1.pad("VCC"),
                ...
                [J1.padX("VCC"), IC1.padY("PA1")-.09],
                J1.pad("VCC"),), w);

board.wire(path(IC1.pad("PA3"),
                [R1.posX, IC1.padY("PA3")],
                R1.pad("2"),), w);

board.wire(path(J1.pad("GND"),
                [J1.padX("GND"), J1.posY-.1],
