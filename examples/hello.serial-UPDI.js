...
let J2 = board.add(header_UPDI_reverse, {translate: pt(x+.23, y+height/2), id: 'J2\nUPDI'});
let R1 = board.add(R_1206, {translate: pt(J2.posX, J1.padY("GND")-.05), id: 'R1 4.99k'});
...
board.wire(path(J2.pad("UPDI"),
                [(J1.posX+J2.posX)/2, J2.padY("UPDI")],
                [(J1.posX+J2.posX)/2, J1.padY("Rx")],
                J1.pad("Rx"),), w);

board.wire(path(J2.pad("GND"),
                [J2.posX-.12, J2.padY("GND")],
                [J2.posX-.12, J1.padY("GND")+.01],
                [J1.posX, J1.padY("GND")+.01],
                J1.pad("GND"),), w);
