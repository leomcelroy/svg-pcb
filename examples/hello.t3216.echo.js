...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(ATtiny3216, {translate: pt(x+.3, y+.58), label: 'IC1\nt3216'});
let C1 = board.add(C_1206, {translate: pt(IC1.posX, IC1.padY("VCC")+.09), label: 'C1 1uF'});
...
let interior = geo.path(path([1.000, 1.980],
                             [1.890, 1.980],
                             [1.890, 1.000],
                             [1.000, 1.000]));
