...
const header_serial_reverse = {"GND":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,-0.25],"layers":["F.Cu"],"index":1},"CTS":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,-0.15],"layers":["F.Cu"],"index":2},"VCC":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,-0.05],"layers":["F.Cu"],"index":3},"Tx":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,0.05],"layers":["F.Cu"],"index":4},"Rx":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,0.15],"layers":["F.Cu"],"index":5},"RTS":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,0.25],"layers":["F.Cu"],"index":6}};
...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.45, y+height-.59), name: 'IC1\nD11C'});
let J1 = board.add(header_SWD_4_1, {translate: pt(IC1.posX+.015, IC1.padY("CLK")-.14), name: 'J1 SWD'});
let J2 = board.add(USB_A_plug, {translate: pt(x+width/2, y+height-.29), rotate: 90, name: 'J2\nUSB'});
let J3 = board.add(header_serial_reverse, {translate: pt(IC1.posX, y+.23), rotate: -90, name: 'J3 serial'});
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A05")-.21, IC1.padY("A09")), rotate: -90, name: 'IC2\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC2.posX, IC2.posY-.24), rotate: 90, name: 'C1\n1uF'});
let R1 = board.add(R_1206, {translate: pt(J3.padX("Rx")-.02, J1.posY-.2), name: 'R1\n0'});
let R2 = board.add(R_1206, {translate: pt(C1.posX-.03, J3.posY+.18), rotate: 90, name: 'R2\n0'});
let R3 = board.add(R_1206, {translate: pt(R1.posX-.22, R1.posY), name: 'R3\n4.99k'});
...
board.wire([J2.pad("D-"),
            pt(J2.padX("D-"), J2.padY("D-")-.08),
            pt(IC1.posX-.015, J2.padY("D-")-.08),
            pt(IC1.posX-.015, IC1.padY("24-")),
            IC1.pad("24-")], w);

board.wire([J2.pad("D+"),
            pt(J2.padX("D+"), J2.padY("D+")-.03),
            pt(IC1.posX+.015, J2.padY("D+")-.06),
...
board.wire([J3.pad("Tx"),
            pt(J3.padX("Tx"), J3.posY-.13),
            pt(J3.padX("RTS")+.055, J3.posY-.13),
            pt(J3.padX("RTS")+.055, IC1.padY("A04")),
            IC1.pad("A04")], w);

board.wire([J3.pad("RTS"),
            pt(J3.padX("RTS")+.025, J3.posY),
            pt(J3.padX("RTS")+.025, IC1.padY("A02")),
            IC1.pad("A02")], w);
...
board.wire([R1.pad("1"),
            pt(R1.padX("1"), J3.posY+.12),
            pt(J3.padX("CTS"), J3.posY+.12),
            J3.pad("CTS")], w);

board.wire([R1.pad("2"),
            pt(R1.padX("2"), R1.posY+.09),
            pt(IC1.padX("A09")-.09, R1.posY+.09),
            pt(IC1.padX("A09")-.09, IC1.padY("A14")),
            IC1.pad("A14")], w);

board.wire([C1.pad("1"),
            pt(C1.posX+.06, C1.padY("1")),
            pt(C1.posX+.06, J3.posY+.12),
            pt(J3.padX("GND")+.05, J3.posY+.12),
            pt(J3.padX("GND")+.05, J3.posY-.1),
            pt(J3.padX("CTS")+.05, J3.posY-.1),
            pt(J3.padX("CTS")+.05, J3.posY+.09),
            pt(J3.padX("Tx")+.05, J3.posY+.09),
            pt(J3.padX("Tx")+.05, J3.posY-.1),
            pt(J3.padX("Rx")+.05, J3.posY-.1),
            pt(J3.padX("Rx")+.05, J3.posY+.09),
            pt(J3.padX("Rx")+.095, J3.posY+.09),
            pt(J3.padX("Rx")+.095, IC1.padY("VDD")),
            IC1.pad("VDD")], w);

board.wire([R2.pad("2"),
            pt(R2.padX("2")-.07, R2.padY("2")),
            pt(R2.padX("2")-.07, J2.padY("5V")-.08),
            pt(J2.padX("5V"), J2.padY("5V")-.08),
            J2.pad("5V")], w);

board.wire([J3.pad("VCC"),
            pt(J3.padX("VCC"), J3.posY-.13),
            pt(R2.posX, J3.posY-.13),
            R2.pad("1")], w);

board.wire([C1.pad("2"),
            pt(C1.posX-.06, C1.padY("2")),
            pt(C1.posX-.06, R2.padY("2")+.07),
            pt(C1.posX+.03, R2.padY("2")+.07),
            pt(C1.posX+.03, R2.posY),
            pt(R2.posX-.07, R2.posY),
            pt(R2.posX-.07, J3.posY-.16),
            pt(J3.padX("RTS")+.085, J3.posY-.16),
            pt(J3.padX("RTS")+.085, J2.padY("GND")-.11),
            pt(J2.padX("GND"), J2.padY("GND")-.11),
            J2.pad("GND")], w);
...
board.wire([C1.pad("2"),
            ...
            pt(C1.posX-.06, R2.padY("2")+.07),
            pt(C1.posX+.03, R2.padY("2")+.07),
            pt(C1.posX+.03, R2.padY("1")-.02),
            pt(J3.padX("GND"), J3.padY("GND")+.04),
            J3.pad("GND")], w);

board.wire([J3.pad("Rx"),
            pt(R1.posX, J3.padY("Rx")),
            pt(R1.posX, R1.posY+.06),
            pt(R3.padX("2"), R1.posY+.06),
            R3.pad("2")], w);

board.wire([R3.pad("1"),
            pt(IC1.padX("A05")-.12, R3.posY),
            pt(IC1.padX("A05")-.12, IC1.padY("A05")),
            IC1.pad("A05")], w);
