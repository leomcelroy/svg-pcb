...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.45, y+height-.59), id: 'IC1\nD11C'});
...
let J3 = board.add(header_serial_reverse, {translate: pt(IC1.posX, y+.23), rotate: -90, id: 'J3 serial'});
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A05")-.21, IC1.padY("A09")), rotate: -90, id: 'IC2\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC2.posX, IC2.posY-.24), rotate: 90, id: 'C1\n1uF'});
let R1 = board.add(R_1206, {translate: pt(J3.padX("Rx")-.02, J1.posY-.2), id: 'R1\n0'});
let R2 = board.add(R_1206, {translate: pt(C1.posX-.03, J3.posY+.18), rotate: 90, id: 'R2\n0'});
let R3 = board.add(R_1206, {translate: pt(R1.posX-.22, R1.posY), id: 'R3\n4.99k'});
...
board.wire(path(J1.pad("RST"),
                [IC1.padX("RST")-.06, J1.padY("RST")],
                [IC1.padX("RST")-.06, IC1.padY("RST")],
                IC1.pad("RST"),), w);

board.wire(path(J2.pad("D-"),
                [J2.padX("D-"), J2.padY("D-")-.08],
                [IC1.posX-.015, J2.padY("D-")-.08],
                [IC1.posX-.015, IC1.padY("24-")],
                IC1.pad("24-"),), w);

board.wire(path(J2.pad("D+"),
                [J2.padX("D+"), J2.padY("D+")-.03],
                [IC1.posX+.015, J2.padY("D+")-.06],
...
board.wire(path(J3.pad("Tx"),
                [J3.padX("Tx"), J3.posY-.13],
                [J3.padX("RTS")+.055, J3.posY-.13],
                [J3.padX("RTS")+.055, IC1.padY("A04")],
                IC1.pad("A04"),), w);

board.wire(path(J3.pad("RTS"),
                [J3.padX("RTS")+.025, J3.posY],
                [J3.padX("RTS")+.025, IC1.padY("A02")],
                IC1.pad("A02"),), w);
...
board.wire(path(C1.pad("1"),
                ...
                [J3.padX("Tx")+.05, J3.posY+.09],
                [J3.padX("Tx")+.05, J3.posY-.1],
                [J3.padX("Rx")+.05, J3.posY-.1],
                [J3.padX("Rx")+.05, J3.posY+.09],
                [J3.padX("Rx")+.095, J3.posY+.09],
                [J3.padX("Rx")+.095, IC1.padY("VDD")],
                IC1.pad("VDD"),), w);

board.wire(path(R2.pad("2"),
                [R2.padX("2")-.07, R2.padY("2")],
                [R2.padX("2")-.07, J2.padY("5V")-.08],
                [J2.padX("5V"), J2.padY("5V")-.08],
                J2.pad("5V"),), w);

board.wire(path(J3.pad("VCC"),
                [J3.padX("VCC"), J3.posY-.13],
                [R2.posX, J3.posY-.13],
                R2.pad("1"),), w);
...
board.wire(path(C1.pad("2"),
                ...
                [C1.posX+.03, R2.posY],
                [R2.posX-.07, R2.posY],
                [R2.posX-.07, J3.posY-.16],
                [J3.padX("RTS")+.085, J3.posY-.16],
                [J3.padX("RTS")+.085, J2.padY("GND")-.11],
                [J2.padX("GND"), J2.padY("GND")-.11],
                J2.pad("GND"),), w);
