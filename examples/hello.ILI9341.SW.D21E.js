...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD21E, {translate: pt(x+.62, y+.36), name: 'IC1\nD21E'});
...
let C2 = board.add(C_1206, {translate: pt(IC1.padX("A07")-.255, IC1.padY("VAN")-.08), rotate: 90, name: 'C2\n1uF'});
let IC2 = board.add(regulator_SOT23, {translate: pt(C2.posX-.125, C2.posY), rotate: -90, name: 'IC2\n3.3V'});
let J3 = board.add(TFT8x1v, {translate: pt(IC1.posX-.39, IC1.posY+.25), rotate: 0, name: 'J3 TFT'});
...
board.wire(path(J3.pad("SCK"),
                pt(J3.padX("SCK"), IC1.padY("A04")),
                pt(IC1.padX("A04")-.07, IC1.padY("A04")),
                pt(IC1.padX("A05")-.04, IC1.padY("A05")),
                IC1.pad("A05"),), w);

board.wire(path(J3.pad("MOSI"),
                pt(J3.padX("MOSI"), J3.padY("LED")+.05),
                pt(IC1.padX("A04")-.09, J3.padY("LED")+.05),
                pt(IC1.padX("A04")-.06, IC1.padY("A06")),
                IC1.pad("A06"),), w);
