...
// constants
const width = .75 // board width
const height = 1.09 // board height
const x = 1 // x origin
const y = 1 // y origin
const zt = 0 // top z
...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.33, y+height-.63), label: 'IC1\nD11C'});
...
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A04")+.15, IC1.padY("A08")-.005), rotate: 90, label: 'IC2\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC2.posX, IC2.posY-.2), rotate: 90, label: 'C1\n1uF'});

let interior = geo.path(path([1.000, 2.090],
                             [1.750, 2.090],
                             [1.750, 1.000],
                             [1.000, 1.000]));
...
board.wire(path(J2.pad("5V"),
                ...
                [IC1.padX("RST")-.1, J2.padY("5V")-.11],
                [IC1.padX("RST")-.1, J1.padY("GND")-.09],
                [C1.padX("2")+.1, J1.padY("GND")-.09],
