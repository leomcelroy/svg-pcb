...
const USB_mini_CUI = footprint({"V":{"shape":"M -0.0075,0.0492L 0.0075,0.0492L 0.0075,-0.0492L -0.0075,-0.0492L -0.0075,0.0492","pos":[-0.063,0.2157],"layers":["F.Cu","F.Mask"],"index":1},"-":{"shape":"M -0.0075,0.0492L 0.0075,0.0492L 0.0075,-0.0492L -0.0075,-0.0492L -0.0075,0.0492","pos":[-0.0315,0.2157],"layers":["F.Cu","F.Mask"],"index":2},"+":{"shape":"M -0.0075,0.0492L 0.0075,0.0492L 0.0075,-0.0492L -0.0075,-0.0492L -0.0075,0.0492","pos":[0,0.2157],"layers":["F.Cu","F.Mask"],"index":3},"I":{"shape":"M -0.0075,0.0492L 0.0075,0.0492L 0.0075,-0.0492L -0.0075,-0.0492L -0.0075,0.0492","pos":[0.0315,0.2157],"layers":["F.Cu","F.Mask"],"index":4},"G":{"shape":"M -0.0075,0.0492L 0.0075,0.0492L 0.0075,-0.0492L -0.0075,-0.0492L -0.0075,0.0492","pos":[0.063,0.2157],"layers":["F.Cu","F.Mask"],"index":5},"NC1":{"shape":"M -0.0394,0.0492L 0.0394,0.0492L 0.0394,-0.0492L -0.0394,-0.0492L -0.0394,0.0492","pos":[-0.1913,0],"layers":["F.Cu","F.Mask"],"index":0},"NC2":{"shape":"M -0.0394,0.0492L 0.0394,0.0492L 0.0394,-0.0492L -0.0394,-0.0492L -0.0394,0.0492","pos":[0.1913,0],"layers":["F.Cu","F.Mask"],"index":0},"NC3":{"shape":"M -0.0394,0.0492L 0.0394,0.0492L 0.0394,-0.0492L -0.0394,-0.0492L -0.0394,0.0492","pos":[-0.1913,0.2157],"layers":["F.Cu","F.Mask"],"index":0},"NC4":{"shape":"M -0.0394,0.0492L 0.0394,0.0492L 0.0394,-0.0492L -0.0394,-0.0492L -0.0394,0.0492","pos":[0.1913,0.2157],"layers":["F.Cu","F.Mask"],"index":0}});
...
board.wire(path(J2.pad("I"),
                [J2.padX("I"), J2.padY("I")-.08],), w);

board.wire(path(J2.pad("G"),
                [J2.padX("G"), J2.padY("G")-.08],
                [IC1.padX("CLK")-.1, J2.padY("G")-.08],
...
board.wire(path(J2.pad("V"),
                [J2.padX("V"), J2.padY("V")-.08],
                [IC2.padX("in"), J2.padY("V")-.08],
                IC2.pad("in"),), w);

board.wire(path(IC1.pad("GND"),
                [J2.padX("V"), IC1.padY("GND")],
                [J2.padX("V"), IC1.padY("A04")+.045],
...
board.wire(path(IC1.pad("25+"),
                ...
                [J2.padX("+"), J1.padY("CLK")+.1],
                [J2.padX("+"), IC1.padY("A04")+.05],
                J2.pad("+"),), w);
