...
const header_UPDI_3_reverse = footprint({"VCC":{"shape":"M -0.05,-0.025L 0.0517,-0.025L 0.0535,-0.0248L 0.0552,-0.0244L 0.056,-0.0243L 0.0578,-0.0237L 0.0593,-0.0232L 0.0602,-0.0229L 0.061,-0.0225L 0.0618,-0.0221L 0.0625,-0.0216L 0.0633,-0.0212L 0.064,-0.0208L 0.0654,-0.0197L 0.0661,-0.0191L 0.0668,-0.0186L 0.0686,-0.0168L 0.0691,-0.0161L 0.0697,-0.0154L 0.0708,-0.014L 0.0712,-0.0133L 0.0716,-0.0125L 0.0721,-0.0118L 0.0725,-0.011L 0.0729,-0.0102L 0.0732,-0.0093L 0.0737,-0.0078L 0.0743,-0.006L 0.0744,-0.0052L 0.0748,-0.0035L 0.075,-0.0017L 0.075,-0.0009L 0.075,0L 0.075,0.0009L 0.075,0.0017L 0.0748,0.0035L 0.0744,0.0052L 0.0743,0.006L 0.0737,0.0078L 0.0732,0.0093L 0.0729,0.0102L 0.0725,0.011L 0.0721,0.0118L 0.0716,0.0125L 0.0712,0.0133L 0.0708,0.014L 0.0697,0.0154L 0.0691,0.0161L 0.0686,0.0168L 0.0668,0.0186L 0.0661,0.0191L 0.0654,0.0197L 0.064,0.0208L 0.0633,0.0212L 0.0625,0.0216L 0.0618,0.0221L 0.061,0.0225L 0.0602,0.0229L 0.0593,0.0232L 0.0578,0.0237L 0.056,0.0243L 0.0552,0.0244L 0.0535,0.0248L 0.0517,0.025L 0.0509,0.025L 0.05,0.025L -0.05,0.025L -0.05,-0.025","pos":[0,-0.1],"layers":["F.Cu","F.Mask"],"index":1},"GND":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,0],"layers":["F.Cu","F.Mask"],"index":2},"UPDI":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0,0.1],"layers":["F.Cu","F.Mask"],"index":3}});
...
board.wire(path(J2.pad("VCC"),
                [(J1.posX+J2.posX)/2, J2.padY("VCC")],
                [(J1.posX+J2.posX)/2, J1.padY("VCC")],
                J1.pad("VCC"),), w);

board.wire(path(J2.pad("GND"),
                [J2.posX-.12, J2.padY("GND")],
                [J2.posX-.12, J1.padY("GND")],
                J1.pad("GND"),), w);

board.wire(path(R1.pad("1"),
                [R1.posX+.05, J1.padY("CTS")-.05],
                [J1.posX+.1, J1.padY("CTS")-.05],
                [J1.posX+.1, J1.padY("Tx")],
                J1.pad("Tx"),), w);

board.wire(path(R1.pad("2"),
                [J2.posX-.09, R1.padY("2")],
                [J2.posX-.09, J2.padY("UPDI")],
                J2.pad("UPDI"),), w);

board.wire(path(J1.pad("Rx"),
                [J1.posX+.13, J1.padY("Rx")],
                [J1.posX+.13, J1.padY("CTS")+.05],
                [R1.posX, J1.padY("CTS")+.05],
                R1.pad("2"),), w);
