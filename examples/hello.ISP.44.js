...
const SJ = footprint({"1":{"shape":"M -0.02,0.03L 0.02,0.03L 0.02,-0.03L -0.02,-0.03L -0.02,0.03","pos":[-0.029,0],"layers":["F.Cu","F.Mask"],"index":1},"2":{"shape":"M -0.02,0.03L 0.02,0.03L 0.02,-0.03L -0.02,-0.03L -0.02,0.03","pos":[0.029,0],"layers":["F.Cu","F.Mask"],"index":2}});
const USB_mini_B = footprint({"G":{"shape":"M -0.0075,0.04L 0.0075,0.04L 0.0075,-0.04L -0.0075,-0.04L -0.0075,0.04","pos":[0.063,0.36],"layers":["F.Cu","F.Mask"],"index":1},"NC1":{"shape":"M -0.0075,0.04L 0.0075,0.04L 0.0075,-0.04L -0.0075,-0.04L -0.0075,0.04","pos":[0.0315,0.36],"layers":["F.Cu","F.Mask"],"index":2},"NC2":{"shape":"M -0.049,0.043L 0.049,0.043L 0.049,-0.043L -0.049,-0.043L -0.049,0.043","pos":[0.165,0.33],"layers":["F.Cu","F.Mask"],"index":0},"NC3":{"shape":"M -0.049,0.043L 0.049,0.043L 0.049,-0.043L -0.049,-0.043L -0.049,0.043","pos":[-0.165,0.33],"layers":["F.Cu","F.Mask"],"index":0},"NC4":{"shape":"M -0.049,0.043L 0.049,0.043L 0.049,-0.043L -0.049,-0.043L -0.049,0.043","pos":[0.165,0.12],"layers":["F.Cu","F.Mask"],"index":0},"NC5":{"shape":"M -0.049,0.043L 0.049,0.043L 0.049,-0.043L -0.049,-0.043L -0.049,0.043","pos":[-0.165,0.12],"layers":["F.Cu","F.Mask"],"index":0},"+":{"shape":"M -0.0075,0.04L 0.0075,0.04L 0.0075,-0.04L -0.0075,-0.04L -0.0075,0.04","pos":[0,0.36],"layers":["F.Cu","F.Mask"],"index":3},"-":{"shape":"M -0.0075,0.04L 0.0075,0.04L 0.0075,-0.04L -0.0075,-0.04L -0.0075,0.04","pos":[-0.0315,0.36],"layers":["F.Cu","F.Mask"],"index":4},"V":{"shape":"M -0.0075,0.04L 0.0075,0.04L 0.0075,-0.04L -0.0075,-0.04L -0.0075,0.04","pos":[-0.063,0.36],"layers":["F.Cu","F.Mask"],"index":5}});
...
const D_SOD_123 = footprint({"A":{"shape":"M -0.02,0.024L 0.02,0.024L 0.02,-0.024L -0.02,-0.024L -0.02,0.024","pos":[-0.07,0],"layers":["F.Cu","F.Mask"],"index":1},"C":{"shape":"M -0.02,0.024L 0.02,0.024L 0.02,-0.024L -0.02,-0.024L -0.02,0.024","pos":[0.07,0],"layers":["F.Cu","F.Mask"],"index":2}});
const XTAL_NX5032GA = footprint({"1":{"shape":"M -0.039,0.047L 0.039,0.047L 0.039,-0.047L -0.039,-0.047L -0.039,0.047","pos":[-0.079,0],"layers":["F.Cu","F.Mask"],"index":1},"2":{"shape":"M -0.039,0.047L 0.039,0.047L 0.039,-0.047L -0.039,-0.047L -0.039,0.047","pos":[0.079,0],"layers":["F.Cu","F.Mask"],"index":2}});
...
board.wire(path(IC1.pad("PA6"),
                [IC1.padX("PA6"), J1.posY],
                [J1.padX("MOSI"), J1.posY],
                J1.pad("MOSI"),), w);

board.wire(path(IC1.pad("PA3"),
                [J1.padX("RST")+.05, IC1.padY("PA3")],
                [J1.padX("RST")+.05, J1.padY("RST")],
                J1.pad("RST"),), w);

board.wire(path(J1.pad("RST"),
                [J1.padX("RST"), J1.posY+.0325],
                [J1.posX+.05, J1.posY+.0325],
                [J1.posX+.05, J1.padY("MOSI")-.075],
                [J1.posX-.05, J1.padY("MOSI")-.075],
                [J1.posX-.05, J1.posY-.0325],
                [SJ1.padX("1"), J1.posY-.0325],
                SJ1.pad("1"),), w);

board.wire(path(IC1.pad("PB3"),
                [SJ1.padX("2"), IC1.padY("PB3")],
                SJ1.pad("2"),), w);
...
board.wire(path(R2.pad("1"),
                [R2.posX+.075, R2.padY("1")],
                [R2.posX+.075, R1.posY+.06],
                [J2.padX("V"), R1.posY+.06],
                J2.pad("V"),), w);
...
board.wire(path(J1.pad("V"),
                [SJ2.posX+.02, J1.padY("V")],
                [SJ2.posX+.02, SJ2.padY("1")],), w);

board.wire(path(SJ2.pad("2"),
                [R2.padX("1"), SJ2.padY("2")],
                R2.pad("1"),), w);

board.wire(path(IC1.pad("GND"),
                [IC1.padX("GND")-.02, IC1.padY("GND")],
                [IC1.padX("GND")-.02, SJ2.posY],
                [J1.padX("V")+.085, SJ2.posY],
                [J1.padX("V")+.085, J1.padY("V")-.11],
                [J1.padX("GND"), J1.padY("V")-.11],
                J1.pad("GND"),), w);
...
board.wire(path(IC1.pad("PB2"),
                [R3.padX("1"), IC1.padY("PB2")],
                R3.pad("1"),), w);

board.wire(path(IC1.pad("PA7"),
                [R3.padX("1"), IC1.padY("PA7")],
                R3.pad("1"),), w);
...
board.wire(path(D2.pad("A"),
                [D2.padX("A"), R3.posY],
                [IC1.padX("GND")-.02, R3.posY],
                [IC1.padX("GND")-.02, IC1.padY("GND")],), w);

board.wire(path(R2.pad("1"),
                [R2.posX+.075, R2.padY("1")],
                [R2.posX+.075, R5.padY("1")-.085],
                [R5.padX("1"), R5.padY("1")-.085],
                R5.pad("1"),), w);

board.wire(path(SJ1.pad("2"),
                [R5.padX("2"), SJ1.padY("2")],
                R5.pad("2"),), w);

board.wire(path(IC1.pad("PB0"),
                [XTAL1.padX("2")+.035, IC1.padY("PB0")],
                [XTAL1.padX("2")+.035, XTAL1.padY("2")],), w);

board.wire(path(IC1.pad("PB1"),
                [XTAL1.padX("2")+.035, IC1.padY("PB1")],
                [XTAL1.padX("1")+.035, XTAL1.padY("1")],), w);

board.wire(path([R5.posX, R5.padY("1")-.085],
                [C1.padX("1"), R5.padY("1")-.085],
                C1.pad("1"),), w);
...
board.wire(path(C2.pad("2"),
                [XTAL1.padX("2"), C2.padY("2")],
                XTAL1.pad("2"),), w);

board.wire(path(C3.pad("1"),
                [XTAL1.padX("1"), C3.padY("1")],
                XTAL1.pad("1"),), w);

board.wire(path(C2.pad("1"),
                C3.pad("2"),), w);

board.wire(path([C1.posX, C1.posY],
                [C2.posX-.06, C1.posY],
                [C2.posX-.06, XTAL1.posY],
                [C2.posX, XTAL1.posY],), w);

board.wire(path([C1.posX, C1.padY("1")-.085],
                [C2.posX-.095, C1.padY("1")-.085],
                [C2.posX-.095, R3.posY],
                [D2.padX("A")-.05, R3.posY],
                [D2.padX("A")-.05, R3.padY("1")],
                [IC1.padX("VCC"), R3.padY("1")],
                IC1.pad("VCC"),), w);
