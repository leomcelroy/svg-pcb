...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.24, y+height-.44), name: 'IC1\nD11C'});
let J1 = board.add(header_SWD_4_1, {translate: pt(IC1.posX+.015, IC1.padY("CLK")-.14), name: 'J1 SWD'});
let J2 = board.add(USB_micro_Elektronik, {translate: pt(IC1.posX-.028, y+height-.05), rotate: 180, name: 'J2 USB'});
