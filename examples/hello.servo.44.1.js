...
const regulator_SOT223_1 = footprint({"I":{"shape":"M -0.02,0.03L 0.02,0.03L 0.02,-0.03L -0.02,-0.03L -0.02,0.03","pos":[-0.09,-0.12],"layers":["F.Cu","F.Mask"],"index":1},"G1":{"shape":"M -0.02,0.03L 0.02,0.03L 0.02,-0.03L -0.02,-0.03L -0.02,0.03","pos":[0,-0.12],"layers":["F.Cu","F.Mask"],"index":2},"G2":{"shape":"M -0.065,0.03L 0.065,0.03L 0.065,-0.03L -0.065,-0.03L -0.065,0.03","pos":[0,0.12],"layers":["F.Cu","F.Mask"],"index":4},"O":{"shape":"M -0.02,0.03L 0.02,0.03L 0.02,-0.03L -0.02,-0.03L -0.02,0.03","pos":[0.09,-0.12],"layers":["F.Cu","F.Mask"],"index":3}});
...
let J2 = board.add(header_power, {translate: pt(x+.18, y+height-.1), label: 'J2\npower'});
let IC2 = board.add(regulator_SOT223_1, {translate: pt(J2.posX+.37, J2.posY-.04), rotate: -90, label: 'IC2\n5V'});
...
board.wire(path(IC2.pad("O"),
                [IC1.padX("VCC"), IC2.padY("O")],
                IC1.pad("VCC"),), w);

board.wire(path(IC2.pad("G2"),
                [IC1.padX("GND"), IC2.padY("G2")],
                IC1.pad("GND"),), w);
