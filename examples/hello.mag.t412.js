...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(ATtiny412, {translate: pt(x+.32, y+.44), name: 'IC1\nt412'});
...
let IC2 = board.add(Hall_SOT23, {translate: pt(J2.padX("GND")-.11, J2.posY), rotate: -90, name: "IC2\nA1324"});
...
board.wire([IC1.pad("PA6"),
            ...
            pt(IC1.padX("PA6")-.16, J2.posY-.14),
            pt(J1.posX-.08, J2.posY-.14),
            pt(J1.posX-.08, J1.padY("Rx")),
            J1.pad("Rx")], w);

board.wire([IC1.pad("PA7"),
            pt(IC1.padX("PA7")-.13, IC1.padY("PA7")),
            pt(IC1.padX("PA7")-.13, J2.posY-.11),
            pt(J1.posX-.11, J2.posY-.11),
...
board.wire([IC1.pad("VCC"),
            ...
            pt(IC2.padX("Vcc"), IC1.padY("PA1")-.05),
            IC2.pad("Vcc")], w);

board.wire([IC1.pad("PA1"),
            pt(IC2.padX("out"), IC1.padY("PA1")),
            IC2.pad("out")], w);

board.wire([IC2.pad("gnd"),
            pt(J2.padX("GND"), IC2.padY("gnd")),
            J2.pad("GND")], w);
