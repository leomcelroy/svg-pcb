...
board.wire(path(C1.pad("1"),
                ...
                [J1.posX+.1, C1.padY("1")+.06],
                [J1.posX+.1, J1.padY("VCC")],
                J1.pad("VCC"),), w);

board.wire(path([C1.padX("2"), J1.padY("GND")],
                [IC1.padX("GND"), J1.padY("GND")],
                IC1.pad("GND"),), w);
...
board.wire(path(IC1.pad("PA6"),
                [IC1.padX("PA6")-.16, IC1.padY("PA6")],
                [IC1.padX("PA6")-.16, J2.posY-.14],
                [J1.posX-.08, J2.posY-.14],
                [J1.posX-.08, J1.padY("Rx")],
                J1.pad("Rx"),), w);

board.wire(path(IC1.pad("PA7"),
                [IC1.padX("PA7")-.13, IC1.padY("PA7")],
                [IC1.padX("PA7")-.13, J2.posY-.11],
                [J1.posX-.11, J2.posY-.11],
                [J1.posX-.11, J1.padY("Tx")],
                J1.pad("Tx"),), w);

board.wire(path(IC1.pad("VCC"),
                [IC1.posX-.03, IC1.padY("VCC")],
                [IC1.posX-.03, IC1.padY("PA1")-.05],
                [IC2.padX("Vcc"), IC1.padY("PA1")-.05],
                IC2.pad("Vcc"),), w);

board.wire(path(IC1.pad("PA1"),
                [IC2.padX("out"), IC1.padY("PA1")],
                IC2.pad("out"),), w);

board.wire(path(IC2.pad("gnd"),
                [J2.padX("GND"), IC2.padY("gnd")],
                J2.pad("GND"),), w);
