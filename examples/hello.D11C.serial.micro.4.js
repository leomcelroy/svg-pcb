...
const USB_micro_Elektronik = {"V":{"shape":"M -0.0049,0.0266L 0.0049,0.0266L 0.0049,-0.0266L -0.0049,-0.0266L -0.0049,0.0266","pos":[-0.0512,0.1132],"layers":["F.Cu"],"index":1},"-":{"shape":"M -0.0049,0.0266L 0.0049,0.0266L 0.0049,-0.0266L -0.0049,-0.0266L -0.0049,0.0266","pos":[-0.0256,0.1132],"layers":["F.Cu"],"index":2},"+":{"shape":"M -0.0049,0.0266L 0.0049,0.0266L 0.0049,-0.0266L -0.0049,-0.0266L -0.0049,0.0266","pos":[0,0.1132],"layers":["F.Cu"],"index":3},"I":{"shape":"M -0.0049,0.0266L 0.0049,0.0266L 0.0049,-0.0266L -0.0049,-0.0266L -0.0049,0.0266","pos":[0.0256,0.1132],"layers":["F.Cu"],"index":4},"G":{"shape":"M -0.0049,0.0266L 0.0049,0.0266L 0.0049,-0.0266L -0.0049,-0.0266L -0.0049,0.0266","pos":[0.0512,0.1132],"layers":["F.Cu"],"index":5},"NC1":{"shape":"M -0.0354,0.0374L 0.0354,0.0374L 0.0354,-0.0374L -0.0354,-0.0374L -0.0354,0.0374","pos":[-0.1575,0],"layers":["F.Cu"],"index":0},"NC2":{"shape":"M -0.0354,0.0374L 0.0354,0.0374L 0.0354,-0.0374L -0.0354,-0.0374L -0.0354,0.0374","pos":[0.1575,0],"layers":["F.Cu"],"index":0}};
...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.36, y+height-.43), name: 'IC1\nD11C'});
let J1 = board.add(header_SWD_4_1, {translate: pt(IC1.posX, IC1.padY("CLK")-.14), name: 'J1 SWD'});
let J2 = board.add(USB_micro_Elektronik, {translate: pt(IC1.posX, y+height-.05), rotate: 180, name: 'J2\nmicro USB'});
let J3 = board.add(header_serial_Frev, {translate: pt(IC1.posX, y+.23), rotate: 90, name: 'J3\nserial F'});
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A04")+.2, IC1.padY("GND")-.01), rotate: -90, name: 'IC2\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC2.posX, IC2.posY-.24), rotate: 90, name: 'C1\n1uF'});
let R3 = board.add(R_1206, {translate: pt(IC2.padX("in"), IC2.padY("in")+.1), name: 'R3 0'});
let R4 = board.add(R_1206, {translate: pt(J3.padX("G")-.11, J3.posY+.11), rotate: 90, name: 'R4\n4.99k'});
...
board.wire(path(J1.pad("RST"),
                pt(J1.padX("RST")-.09, J1.padY("RST")),
                pt(J1.padX("RST")-.09, IC1.padY("RST")),
                IC1.pad("RST"),), w);
...
board.wire(path(IC1.pad("25+"),
                pt(J1.padX("DIO")+.06, IC1.padY("25+")),
                pt(J1.padX("DIO")+.09, IC1.padY("25+")-.03),
                pt(J1.padX("DIO")+.09, J1.posY),
                pt(J2.padX("+")+.005, J1.posY),), w);

board.wire(path(pt(J2.padX("+"), J1.posY),
                J2.pad("+"),), w1);

board.wire(path(J2.pad("I"),
                pt(J2.padX("I"), J2.padY("I")-.07),), w1);

board.wire(path(IC2.pad("out"),
                pt(IC2.padX("out"), IC2.posY),
                pt(J1.padX("DIO")+.13, IC2.posY),), w1);

board.wire(path(pt(J1.padX("DIO")+.13, IC2.posY+.002),
                pt(J1.padX("DIO")+.08, IC1.padY("VDD")),
                IC1.pad("VDD"),), w);

board.wire(path(J2.pad("V"),
                pt(J2.padX("V"), J2.padY("V")-.07),), w1);

board.wire(path(pt(J2.padX("V")+.005, J2.padY("V")-.07),
                pt(IC2.padX("in"), J2.padY("V")-.07),
                IC2.pad("in"),), w);

board.wire(path(IC2.pad("gnd"),
                pt(J1.padX("GND")+.12, IC2.padY("gnd")),
                pt(J1.padX("GND")+.12, J1.padY("GND")),
                J1.pad("GND"),), w);

board.wire(path(IC1.pad("GND"),
                pt(J1.padX("GND")+.07, IC1.padY("GND")),
                pt(J1.padX("GND")+.12, IC1.padY("GND")-.05),
                pt(J1.padX("GND")+.12, J1.padY("GND")),
                J1.pad("GND"),), w);

board.wire(path(C1.pad("1"),
                pt(C1.padX("1")+.08, C1.padY("1")),
                pt(C1.padX("1")+.08, IC2.padY("out")),
                IC2.pad("out"),), w);
...
board.wire(path(IC2.pad("in"),
                pt(IC2.padX("in"), J2.padY("V")-.07),
                pt(C1.posX+.14, J2.padY("V")-.07),
                pt(C1.posX+.14, J3.posY-.11),
                pt(J3.padX("5V"), J3.posY-.11),
                J3.pad("5V"),), w);

board.wire(path(IC1.pad("A04"),
                pt(R3.padX("1"), IC1.padY("A04")),
                R3.pad("1"),), w);

board.wire(path(R3.pad("2"),
                pt(C1.posX+.11, R3.posY),
                pt(C1.posX+.11, J3.posY-.08),
                pt(J3.padX("Tx"), J3.posY-.08),
                J3.pad("Tx"),), w);

board.wire(path(J3.pad("Rx"),
                pt(J3.padX("Rx"), J3.posY+.08),
                pt(J3.padX("G")+.05, J3.posY+.08),
                pt(J3.padX("G")+.05, J3.posY-.08),
                pt(R4.posX, J3.posY-.08),
                R4.pad("1"),), w);

board.wire(path(IC1.pad("A05"),
                pt(R4.posX, IC1.padY("A05")),
                R4.pad("2"),), w);

board.wire(path(J2.pad("G"),
                pt(J2.padX("G"), J2.padY("G")-.07),), w1);

board.wire(path(pt(J2.padX("G")-.005, J2.padY("G")-.07),
                pt(R4.posX-.07, J2.padY("G")-.07),
                pt(R4.posX-.07, R4.posY),
                pt(J1.posX, R4.posY),
                pt(J1.posX, J1.padY("GND")),
                J1.pad("GND"),), w);

board.wire(path(J3.pad("G"),
                pt(J3.padX("G"), R4.posY),
                pt(J1.posX, R4.posY),
                pt(J1.posX, J1.padY("GND")),
                J1.pad("GND"),), w);
