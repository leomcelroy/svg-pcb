...
board.wire(path(IC1.pad("PA2"),
                [IC1.padX("PA2"), R1.posY],
                R1.pad("2"),), w);

board.wire(path(LED1.pad("A"),
                [IC1.padX("VCC")-.06, LED1.padY("A")],
                [IC1.padX("VCC")-.06, IC1.padY("VCC")],
                IC1.pad("VCC"),), w);
...
board.wire(path(C1.pad("1"),
                [C1.padX("1"), J1.padY("GND")+.05],
                [J1.posX+.1, J1.padY("GND")+.05],
                [J1.posX+.1, J1.padY("VCC")],
                J1.pad("VCC"),), w);

board.wire(path(IC1.pad("UPDI"),
                [IC1.padX("UPDI")+.06, IC1.padY("UPDI")],
                [IC1.padX("UPDI")+.06, R2.padY("1")],
                R2.pad("1"),), w);
