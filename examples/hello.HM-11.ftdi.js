...
const HM11 = footprint({"RTS":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,0.0886],"layers":["F.Cu","F.Mask"],"index":1},"TX":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,0.0295],"layers":["F.Cu","F.Mask"],"index":2},"CTS":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,-0.0295],"layers":["F.Cu","F.Mask"],"index":3},"RX":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,-0.0886],"layers":["F.Cu","F.Mask"],"index":4},"NC1":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,-0.1476],"layers":["F.Cu","F.Mask"],"index":5},"NC2":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,-0.2067],"layers":["F.Cu","F.Mask"],"index":6},"NC3":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,-0.2657],"layers":["F.Cu","F.Mask"],"index":7},"NC4":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[-0.2657,-0.3248],"layers":["F.Cu","F.Mask"],"index":8},"NC5":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,-0.2657],"layers":["F.Cu","F.Mask"],"index":10},"VCC":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,-0.3248],"layers":["F.Cu","F.Mask"],"index":9},"RST":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,-0.2067],"layers":["F.Cu","F.Mask"],"index":11},"GND":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,-0.1476],"layers":["F.Cu","F.Mask"],"index":12},"IO3":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,-0.0886],"layers":["F.Cu","F.Mask"],"index":13},"IO2":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,-0.0295],"layers":["F.Cu","F.Mask"],"index":14},"IO1":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,0.0295],"layers":["F.Cu","F.Mask"],"index":15},"IO0":{"shape":"M -0.047,0.0177L 0.047,0.0177L 0.047,-0.0177L -0.047,-0.0177L -0.047,0.0177","pos":[0.2657,0.0886],"layers":["F.Cu","F.Mask"],"index":16}});
...
let IC1 = board.add(regulator_SOT23, {translate: pt(J1.posX-.18, J1.padY("CTS")), rotate: 90, label: 'IC1\n3.3V'});
...
board.wire(path(HM.pad("TX"),
                [HM.padX("TX"), HM.padY("TX")-.09],
                [IC1.posX, HM.padY("TX")-.09],
                [IC1.posX, J1.padY("Rx")],
                J1.pad("Rx"),), w);

board.wire(path(J1.pad("Tx"),
                [HM.padX("RX"), J1.padY("Tx")],
                HM.pad("RX"),), w);

board.wire(path(C1.pad("1"),
                [HM.padX("VCC"), C1.padY("1")],
                HM.pad("VCC"),), w);

board.wire(path(HM.pad("GND"),
                [HM.padX("GND"), HM.padY("GND")+.09],
                [IC1.padX("gnd"), HM.padY("GND")+.09],
                IC1.pad("gnd"),), w);
