...
board.wire([pt(J2.padX("GND")-.05, R2.padY("1")),
            R2.pad("1")], w);

board.wire([pt(R2.posX-.07, R2.padY("2")),
            R2.pad("2")], w);
...
board.wire([pt(IC3.padX("SDA"), R1.posY-.09),
            IC3.pad("SDA")], w1);
...
board.wire([IC3.pad("VDD"),
            pt(R1.posX, IC3.padY("VDD")),
            pt(R1.posX, R3.padY("1"))], w1);

board.wire([pt(R1.posX, R3.padY("1")),
