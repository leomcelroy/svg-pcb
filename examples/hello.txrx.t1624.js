...
const header_txrx = {"Rx":{"shape":"M -0.05 0.02500000000000001L 0.05 0.02500000000000001L 0.05 -0.024999999999999994L -0.05 -0.02500000000000001L -0.05 0.024999999999999994","pos":[-0.107,0.05],"layers":["F.Cu"],"index":1},"GND1":{"shape":"M -0.05 0.02500000000000001L 0.05 0.02500000000000001L 0.05 -0.024999999999999994L -0.05 -0.02500000000000001L -0.05 0.024999999999999994","pos":[0.107,0.05],"layers":["F.Cu"],"index":2},"GND2":{"shape":"M -0.05 0.02500000000000001L 0.05 0.02500000000000001L 0.05 -0.024999999999999994L -0.05 -0.02500000000000001L -0.05 0.024999999999999994","pos":[-0.107,-0.05],"layers":["F.Cu"],"index":3},"Tx":{"shape":"M -0.05 0.02500000000000001L 0.05 0.02500000000000001L 0.05 -0.024999999999999994L -0.05 -0.02500000000000001L -0.05 0.024999999999999994","pos":[0.107,-0.05],"layers":["F.Cu"],"index":4}};
...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(ATtiny1614, {translate: pt(x+width-.5, y+.51), name: 'IC1\nt1624'});
...
let J3 = board.add(header_txrx, {translate: pt(x+.13, y+.41), rotate: 90, name: 'J3\nTxRx'});
let R1 = board.add(R_1206, {translate: pt(J3.posX, J3.posY+.22), name: 'R1 1M'});
let R2 = board.add(R_1206, {translate: pt(R1.posX, R1.posY+.1), name: 'R2 1M'});
...
board.wire([J2.pad("UPDI"),
            pt(IC1.posX+.015, J2.padY("UPDI")+.08),
            pt(IC1.posX+.015, IC1.padY("UPDI")),
            IC1.pad("UPDI")], w);

board.wire([J2.pad("GND"),
            pt(IC1.posX-.015, J2.padY("GND")+.08),
            pt(IC1.posX-.015, IC1.padY("GND")),
            IC1.pad("GND")], w);

board.wire([IC1.pad("TB2"),
            pt(IC1.padX("TB2"), J1.padY("RTS")-.02),
            pt(IC1.padX("GND"), J1.padY("RTS")-.02),
            pt(IC1.padX("GND"), J1.padY("Rx")),
            J1.pad("Rx")], w);

board.wire([IC1.pad("RB3"),
            pt(IC1.padX("RB3")-.07, IC1.padY("RB3")),
            pt(IC1.padX("RB3")-.07, J1.padY("RTS")-.05),
            pt(J1.posX+.1, J1.padY("RTS")-.05),
            pt(J1.posX+.1, J1.padY("Tx")),
            J1.pad("Tx")], w);

board.wire([IC1.pad("PA5"),
            pt(J3.padX("Tx"), IC1.padY("PA5")),
            J3.pad("Tx")], w);

board.wire([J3.pad("GND1"),
            pt(J3.padX("GND1")-.05, J3.padY("GND1")),
            pt(J3.padX("GND1")-.05, J1.padY("RTS")-.08),
            pt(J3.padX("GND2"), J1.padY("RTS")-.08),
            J3.pad("GND2")], w);

board.wire([J3.pad("GND2"),
            pt(J3.padX("GND2"), J1.padY("RTS")-.08),
            pt(J1.posX+.13, J1.padY("RTS")-.08),
...
board.wire([J3.pad("GND1"),
            pt(J3.padX("GND1"), R1.posY),
            R1.pad("1")], w);

board.wire([IC1.pad("PA4"),
            pt(R1.padX("2"), IC1.padY("PA4")),
            R1.pad("2")], w);
