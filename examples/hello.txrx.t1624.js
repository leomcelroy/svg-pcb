...
const header_txrx = footprint({"Rx":{"shape":"M -0.05 0.025L 0.05 0.025L 0.05 -0.025L -0.05 -0.025L -0.05 0.025","pos":[-0.107,0.05],"layers":["F.Cu"],"index":1},"GND1":{"shape":"M -0.05 0.025L 0.05 0.025L 0.05 -0.025L -0.05 -0.025L -0.05 0.025","pos":[0.107,0.05],"layers":["F.Cu"],"index":2},"GND2":{"shape":"M -0.05 0.025L 0.05 0.025L 0.05 -0.025L -0.05 -0.025L -0.05 0.025","pos":[-0.107,-0.05],"layers":["F.Cu"],"index":3},"Tx":{"shape":"M -0.05 0.025L 0.05 0.025L 0.05 -0.025L -0.05 -0.025L -0.05 0.025","pos":[0.107,-0.05],"layers":["F.Cu"],"index":4}});
...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(ATtiny1614, {translate: pt(x+width-.5, y+.51), id: 'IC1\nt1624'});
...
let J3 = board.add(header_txrx, {translate: pt(x+.13, y+.41), rotate: 90, id: 'J3\nTxRx'});
let R1 = board.add(R_1206, {translate: pt(J3.posX, J3.posY+.22), id: 'R1 1M'});
let R2 = board.add(R_1206, {translate: pt(R1.posX, R1.posY+.1), id: 'R2 1M'});
...
board.wire(path(J2.pad("UPDI"),
                [IC1.posX+.015, J2.padY("UPDI")+.08],
                [IC1.posX+.015, IC1.padY("UPDI")],
                IC1.pad("UPDI"),), w);

board.wire(path(J2.pad("GND"),
                [IC1.posX-.015, J2.padY("GND")+.08],
                [IC1.posX-.015, IC1.padY("GND")],
                IC1.pad("GND"),), w);

board.wire(path(IC1.pad("TB2"),
                [IC1.padX("TB2"), J1.padY("RTS")-.02],
                [IC1.padX("GND"), J1.padY("RTS")-.02],
                [IC1.padX("GND"), J1.padY("Rx")],
                J1.pad("Rx"),), w);

board.wire(path(IC1.pad("RB3"),
                [IC1.padX("RB3")-.07, IC1.padY("RB3")],
                [IC1.padX("RB3")-.07, J1.padY("RTS")-.05],
                [J1.posX+.1, J1.padY("RTS")-.05],
                [J1.posX+.1, J1.padY("Tx")],
                J1.pad("Tx"),), w);

board.wire(path(IC1.pad("PA5"),
                [J3.padX("Tx"), IC1.padY("PA5")],
                J3.pad("Tx"),), w);

board.wire(path(J3.pad("GND1"),
                [J3.padX("GND1")-.05, J3.padY("GND1")],
                [J3.padX("GND1")-.05, J1.padY("RTS")-.08],
                [J3.padX("GND2"), J1.padY("RTS")-.08],
                J3.pad("GND2"),), w);

board.wire(path(J3.pad("GND2"),
                [J3.padX("GND2"), J1.padY("RTS")-.08],
                [J1.posX+.13, J1.padY("RTS")-.08],
...
board.wire(path(J3.pad("GND1"),
                [J3.padX("GND1"), R1.posY],
                R1.pad("1"),), w);

board.wire(path(IC1.pad("PA4"),
                [R1.padX("2"), IC1.padY("PA4")],
                R1.pad("2"),), w);
...
board.wire(path(C1.pad("1"),
                [C1.padX("1"), C1.padY("1")+.06],
                [R2.padX("2"), C1.padY("1")+.06],
                R2.pad("2"),), w);
