...
board.wire(path(IC1.pad("PA6"),
                [J1.posX+.07, IC1.padY("PA6")],
                [J1.posX+.03, J1.padY("Rx")],
                J1.pad("Rx"),), w);
...
board.wire(path(J1.pad("GND"),
                [J2.padX("GND"), J1.padY("GND")],
                J2.pad("GND"),), w);

board.wire(path(IC3.pad("SCL"),
                [IC3.padX("SCL"), IC3.padY("SCL")-.03],), w);

board.wire(path(IC3.pad("SCL"),
                [IC3.padX("SCL"), IC1.padY("PA2")],
                IC1.pad("PA2"),), w);

board.wire(path(IC3.pad("GND1"),
                [IC3.padX("GND1"), IC3.padY("GND1")-.03],), w);

board.wire(path(IC3.pad("GND2"),
                [IC3.padX("GND2"), IC3.padY("GND2")-.03],), w);

board.wire(path(IC3.pad("GND2"),
                IC3.pad("GND1"),), w);

board.wire(path(IC3.pad("SDA"),
                [IC3.padX("SDA"), IC3.padY("SDA")+.03],), w);

board.wire(path(R1.pad("1"),
                [IC3.padX("SCL"), R1.posY],
                IC3.pad("SCL"),), w);

board.wire(path(R2.pad("1"),
                [R2.padX("1"), J1.padY("GND")-.05],
                [J1.posX-.1, J1.padY("GND")-.05],
                [J1.posX-.1, J1.padY("CTS")+.05],
                [IC1.padX("PA1"), J1.padY("CTS")+.05],
                IC1.pad("PA1"),), w);
...
board.wire(path(R2.pad("1"),
                [R2.posX, R2.posY],
                [R2.posX, R1.posY+.06],
                [IC3.padX("VDD")+.04, R1.posY+.06],
                [IC3.padX("VDD")+.04, IC3.posY+.01],), w);

board.wire(path([IC3.padX("VDD")+.04, IC3.posY+.013],
                [IC3.padX("SDA"), IC3.posY+.013],
                IC3.pad("SDA"),), w1);
...
board.wire(path(IC3.pad("GND1"),
                [IC3.padX("GND1"), IC3.posY-.013],
                [IC3.padX("SCL")-.04, IC3.posY-.013],), w1);

board.wire(path([IC3.padX("SCL")-.04, IC3.posY-.01],
                [IC3.padX("SCL")-.04, C2.posY],
                C2.pad("1"),), w);

board.wire(path(C2.pad("2"),
                [IC3.padX("VDD"), C2.posY],
                IC3.pad("VDD"),), w);

board.wire(path(C2.pad("2"),
                [C2.padX("2")+.06, C2.posY],
                [C2.padX("2")+.06, R1.posY],
                R1.pad("2"),), w);
