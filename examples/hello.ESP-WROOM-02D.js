...
const ESP_WROOM_02D = footprint({"3V3":{"shape":"M -0.0394,0.0148L -0.0394,0.0147L -0.0409,0.0136L -0.0414,0.0132L -0.0427,0.0119L -0.0431,0.0114L -0.0435,0.0109L -0.0439,0.0104L -0.0442,0.0099L -0.0446,0.0094L -0.0449,0.0088L -0.0452,0.0083L -0.0454,0.0078L -0.0457,0.0072L -0.046,0.0066L -0.0464,0.0055L -0.0467,0.0043L -0.0468,0.0037L -0.0471,0.0025L -0.0472,0.0012L -0.0472,-0.0012L -0.0471,-0.0025L -0.0468,-0.0037L -0.0467,-0.0043L -0.0464,-0.0055L -0.046,-0.0066L -0.0457,-0.0072L -0.0454,-0.0078L -0.0452,-0.0083L -0.0449,-0.0088L -0.0446,-0.0094L -0.0442,-0.0099L -0.0439,-0.0104L -0.0435,-0.0109L -0.0431,-0.0114L -0.0427,-0.0119L -0.0414,-0.0132L -0.0409,-0.0136L -0.0394,-0.0147L -0.0394,-0.0148L -0.0394,-0.0177L 0.0394,-0.0177L 0.0394,0.0177L -0.0394,0.0177L -0.0394,0.0148","pos":[-0.3445,0.2362],"layers":["F.Cu","F.Mask"],"index":1},"EN":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,0.1772],"layers":["F.Cu","F.Mask"],"index":2},"IO14":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,0.1181],"layers":["F.Cu","F.Mask"],"index":3},"IO12":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,0.0591],"layers":["F.Cu","F.Mask"],"index":4},"IO13":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,0],"layers":["F.Cu","F.Mask"],"index":5},"IO15":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,-0.0591],"layers":["F.Cu","F.Mask"],"index":6},"IO2":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,-0.1181],"layers":["F.Cu","F.Mask"],"index":7},"IO0":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,-0.1772],"layers":["F.Cu","F.Mask"],"index":8},"GND1":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[-0.3445,-0.2362],"layers":["F.Cu","F.Mask"],"index":9},"GND2":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,-0.0591],"layers":["F.Cu","F.Mask"],"index":13},"GND3":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,0.2362],"layers":["F.Cu","F.Mask"],"index":18},"GND4":{"shape":"M -0.0787,0.0787L 0.0787,0.0787L 0.0787,-0.0787L -0.0787,-0.0787L -0.0787,0.0787","pos":[0.0433,-0.024],"layers":["F.Cu","F.Mask"],"index":19},"IO4":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,-0.2362],"layers":["F.Cu","F.Mask"],"index":10},"RXD":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,-0.1772],"layers":["F.Cu","F.Mask"],"index":11},"TXD":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,-0.1181],"layers":["F.Cu","F.Mask"],"index":12},"IO5":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,0],"layers":["F.Cu","F.Mask"],"index":14},"RST":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,0.0591],"layers":["F.Cu","F.Mask"],"index":15},"TOUT":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,0.1181],"layers":["F.Cu","F.Mask"],"index":16},"IO16":{"shape":"M -0.0394,0.0177L 0.0394,0.0177L 0.0394,-0.0177L -0.0394,-0.0177L -0.0394,0.0177","pos":[0.3445,0.1772],"layers":["F.Cu","F.Mask"],"index":17}});
...
/* -- ADD_COMPONENTS -- */
let J1 = board.add(header_FTDI, {translate: pt(x+width-.22, y+.39), rotate: 0, label: 'J1 serial\n5V power\n3.3V data'});
let IC1 = board.add(regulator_SOT223, {translate: pt(J1.posX-.2, J1.posY-.05), label: '\nIC1\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC1.posX, IC1.posY-.25), label: 'C1\n10uF'});
let C2 = board.add(C_1206, {translate: pt(IC1.posX, IC1.posY+.25), label: 'C2\n1uF'});
let IC2 = board.add(ESP_WROOM_02D, {translate: pt(x+.28, J1.posY+.23), rotate: 90, label: "IC2\n \nESP-WROOM-02D"});
let S1 = board.add(slide_switch, {translate: pt(IC2.padX("GND1")-.06, y+.06), rotate: 0, label: 'prog run\nS1'});
let R1 = board.add(R_1206, {translate: pt(IC2.padX("IO12")-.05, IC2.padY("EN")-.15), label: 'R1 10k'});
let S2 = board.add(button_6mm, {translate: pt(IC2.padX("IO4")+.26, IC2.padY("IO4")-.05), rotate: 0, label: 'S2\nreset'});
let R2 = board.add(R_1206, {translate: pt(S2.posX+.25, S2.posY-.06), rotate: 90, label: 'R2\n10k'});
...
board.wire(path(C2.pad("1"),
                [C2.padX("1"), J1.padY("GND")+.02],
                [J1.padX("GND"), J1.padY("GND")+.02],
                J1.pad("GND"),), w);
...
board.wire(path(IC2.pad("IO15"),
                [IC2.padX("IO15"), IC2.padY("GND4")],
                IC2.pad("GND4"),), w);

board.wire(path(IC2.pad("GND1"),
                [IC2.padX("GND1"), J1.padY("GND")+.02],
                [J1.padX("GND"), J1.padY("GND")+.02],
                J1.pad("GND"),), w);

board.wire(path(IC2.pad("GND1"),
                [IC2.padX("GND1"), IC2.padY("GND4")],
                IC2.pad("GND4"),), w);

board.wire(path(IC2.pad("RXD"),
                [IC2.padX("RXD"), IC2.padY("RXD")-.08],
                [IC2.padX("RXD"), J1.padY("GND")+.06],
                [J1.posX+.1, J1.padY("GND")+.06],
                [J1.posX+.1, J1.padY("Tx")],
                J1.pad("Tx"),), w);

board.wire(path(IC2.pad("TXD"),
                [IC2.padX("TXD"), IC2.padY("TXD")+.08],
                [IC2.padX("IO4")+.05, IC2.padY("TXD")+.08],
                [IC2.padX("IO4")+.05, J1.padY("GND")+.09],
                [J1.posX+.13, J1.padY("GND")+.09],
                [J1.posX+.13, J1.padY("Rx")],
                J1.pad("Rx"),), w);

board.wire(path(IC2.pad("GND2"),
                [IC2.padX("GND2"), IC2.padY("GND4")],
                IC2.pad("GND4"),), w);

board.wire(path(IC2.pad("GND3"),
                [IC2.padX("GND3"), IC2.padY("GND4")],
                IC2.pad("GND4"),), w);

board.wire(path(IC1.pad("G"),
                [IC2.padX("GND1"), IC1.padY("G")],
                [IC2.padX("GND1"), IC2.padY("GND4")],
                IC2.pad("GND4"),), w);

board.wire(path(S1.pad("1"),
                [S1.padX("1")+.04, S1.padY("1")+.04],
                [IC2.padX("IO0"), IC2.padY("IO0")-.05],
                IC2.pad("IO0"),), w);

board.wire(path(S1.pad("2"),
                [IC2.padX("GND1"), IC2.padY("GND1")-.05],
                IC2.pad("GND1"),), w);

board.wire(path(IC2.pad("3V3"),
                [IC2.padX("3V3"), S1.posY-.04],
                [IC1.padX("O"), S1.posY-.04],
                IC1.pad("O"),), w);
...
board.wire(path(R1.pad("2"),
                [R1.padX("2"), S1.posY-.04],), w);

board.wire(path(S2.pad("R2"),
                [S2.posX, S2.padY("R2")],
                [S2.posX, IC2.padY("RST")+.11],
                [IC2.padX("RST"), IC2.padY("RST")+.11],
                IC2.pad("RST"),), w);

board.wire(path(S2.pad("L2"),
                [S2.padX("L2"), IC2.padY("RST")+.14],
                [IC2.padX("GND3"), IC2.padY("RST")+.14],
                IC2.pad("GND3"),), w);

board.wire(path(R2.pad("1"),
                [J1.posX+.16, R2.padY("1")],
                [J1.posX+.16, S1.posY-.04],
                [IC2.padX("3V3"), S1.posY-.04],
                IC2.pad("3V3"),), w);

board.wire(path(R2.pad("2"),
                [S2.padX("R2"), R2.padY("2")],
                S2.pad("R2"),), w);
