...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.58, y+.55), name: 'IC1\nD11'});
...
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A05")-.39, IC1.padY("CLK")-.06), rotate: -90, name: 'IC2\n3.3V'});
...
let J3 = board.add(header_SWD, {translate: pt(IC1.posX-.33, IC1.padY("A09")), rotate: 180, name: 'J3\ntarget'});
...
board.wire([J3.pad("GND1"),
            pt(IC2.padX("gnd"), J3.padY("GND1")),
            IC2.pad("gnd")], w);

board.wire([J3.pad("GND2"),
            pt(IC2.padX("gnd"), J3.padY("GND2")),
            IC2.pad("gnd")], w);

board.wire([J3.pad("GND3"),
            pt(IC2.padX("gnd"), J3.padY("GND3")),
            IC2.pad("gnd")], w);
