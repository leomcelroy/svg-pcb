...
let IC2 = board.add(regulator_SOT23, {translate: pt(IC1.padX("A15"), IC1.padY("24-")-.18), rotate: 0, id: 'IC2\n3.3V'});
let C1 = board.add(C_1206, {translate: pt(IC2.posX-.22, IC2.posY), id: 'C1\n1uF'});
let R1 = board.add(R_1206, {translate: pt(IC1.padX("A04")-.04, IC2.posY), rotate: 90, id: 'R1\n1k'});
let LED = board.add(LED_1206, {translate: pt(R1.posX+.1, R1.posY), rotate: -90, id: 'LED'});
let J3 = board.add(header_servo_1H, {translate: pt(x+.23, y+height/2), id: 'J3\nservo'});
...
board.wire(path(R1.pad("2"),
                [IC1.padX("A02"), R1.padY("2")],
                IC1.pad("A02"),), w1);

board.wire(path(LED.pad("A"),
                [LED.posX, IC1.padY("A04")],
                IC1.pad("A04"),), w1);

board.wire(path(LED.pad("C"),
                R1.pad("1"),), w1);

board.wire(path(J3.pad("S-wh/or"),
                [J3.padX("S-wh/or"), IC1.padY("A05")+.11],
...
board.wire(path(J2.pad("5V"),
                ...
                [J3.padX("V-rd")-.1, IC1.padY("A05")+.15],
                [J3.padX("V-rd")-.1, J3.padY("V-rd")],
                J3.pad("V-rd"),), w2);

board.wire(path(IC2.pad("in"),
                [IC2.padX("in"), IC2.padY("in")-.04],
                [J3.padX("V-rd")+.09, IC2.padY("in")-.04],
                [J3.padX("V-rd")+.09, J3.padY("V-rd")],
                J3.pad("V-rd"),), w1);

board.wire(path(J2.pad("GND"),
                [J2.padX("GND")-.11, J2.padY("GND")],
                [J2.padX("GND")-.11, y+.03],
                [J3.padX("G-bl/br"), y+.03],
                [J3.padX("G-bl/br"), J3.padY("G-bl/br")],), w2);
