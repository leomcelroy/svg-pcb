...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(ATtiny1614, {translate: pt(x+.21, y+.5), label: 'IC1\nt1614'});
...
let J2 = board.add(header_UPDI, {translate: pt(IC1.posX, y+.23), rotate: 90, label: 'J2 UPDI'});

let interior = geo.path(path([1.000, 1.820],
                             [1.680, 1.820],
                             [1.680, 1.000],
                             [1.000, 1.000]));
...
board.wire(path(J2.pad("UPDI"),
                [IC1.posX+.02, J2.padY("UPDI")+.08],
                [IC1.posX+.02, IC1.padY("UPDI")],
                IC1.pad("UPDI"),), w);

board.wire(path(J2.pad("GND"),
                [IC1.posX-.02, J2.padY("GND")+.08],
                [IC1.posX-.02, IC1.padY("GND")],
                IC1.pad("GND"),), w);

board.wire(path(IC1.pad("TB2"),
                [IC1.padX("TB2"), J2.posY-.1],
                [IC1.padX("GND"), J2.posY-.1],
                [IC1.padX("GND"), J1.padY("Rx")],
                J1.pad("Rx"),), w);

board.wire(path(IC1.pad("RB3"),
                [IC1.padX("RB3")-.07, IC1.padY("RB3")],
                [IC1.padX("RB3")-.07, J2.posY-.13],
