...
const header_nRF24L01 = footprint({"GND":{"shape":"M -0.05,-0.025L 0.0517,-0.025L 0.0535,-0.0248L 0.0552,-0.0244L 0.056,-0.0243L 0.0578,-0.0237L 0.0593,-0.0232L 0.0602,-0.0229L 0.061,-0.0225L 0.0618,-0.0221L 0.0625,-0.0216L 0.0633,-0.0212L 0.064,-0.0208L 0.0654,-0.0197L 0.0661,-0.0191L 0.0668,-0.0186L 0.0686,-0.0168L 0.0691,-0.0161L 0.0697,-0.0154L 0.0708,-0.014L 0.0712,-0.0133L 0.0716,-0.0125L 0.0721,-0.0118L 0.0725,-0.011L 0.0729,-0.0102L 0.0732,-0.0093L 0.0737,-0.0078L 0.0743,-0.006L 0.0744,-0.0052L 0.0748,-0.0035L 0.075,-0.0017L 0.075,-0.0009L 0.075,0L 0.075,0.0009L 0.075,0.0017L 0.0748,0.0035L 0.0744,0.0052L 0.0743,0.006L 0.0737,0.0078L 0.0732,0.0093L 0.0729,0.0102L 0.0725,0.011L 0.0721,0.0118L 0.0716,0.0125L 0.0712,0.0133L 0.0708,0.014L 0.0697,0.0154L 0.0691,0.0161L 0.0686,0.0168L 0.0668,0.0186L 0.0661,0.0191L 0.0654,0.0197L 0.064,0.0208L 0.0633,0.0212L 0.0625,0.0216L 0.0618,0.0221L 0.061,0.0225L 0.0602,0.0229L 0.0593,0.0232L 0.0578,0.0237L 0.056,0.0243L 0.0552,0.0244L 0.0535,0.0248L 0.0517,0.025L 0.0509,0.025L 0.05,0.025L -0.05,0.025L -0.05,-0.025","pos":[0.107,-0.15],"layers":["F.Cu","F.Mask"],"index":1},"VCC":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[-0.107,-0.15],"layers":["F.Cu","F.Mask"],"index":2},"CE":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0.107,-0.05],"layers":["F.Cu","F.Mask"],"index":3},"CS":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[-0.107,-0.05],"layers":["F.Cu","F.Mask"],"index":4},"SCK":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0.107,0.05],"layers":["F.Cu","F.Mask"],"index":5},"MOSI":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[-0.107,0.05],"layers":["F.Cu","F.Mask"],"index":6},"MISO":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[0.107,0.15],"layers":["F.Cu","F.Mask"],"index":7},"IRQ":{"shape":"M -0.05,0.025L 0.05,0.025L 0.05,-0.025L -0.05,-0.025L -0.05,0.025","pos":[-0.107,0.15],"layers":["F.Cu","F.Mask"],"index":8}});
...
board.wire(path(IC1.pad("PA2"),
                [IC1.padX("PA2")+.105, IC1.padY("PA2")],
                [IC1.padX("PA2")+.105, J2.padY("Tx")],
                J2.pad("Tx"),), w);

board.wire(path(IC1.pad("PA3"),
                [IC1.padX("PA3")+.07, IC1.padY("PA3")],
                [IC1.padX("PA3")+.07, J2.padY("Rx")],
                J2.pad("Rx"),), w);

board.wire(path(IC2.pad("in"),
                [J2.posX+.08, IC2.padY("in")],
                [J2.posX+.08, J2.padY("VCC")],
                J2.pad("VCC"),), w);

board.wire(path(IC2.pad("gnd"),
                [J1.posX+.05, IC2.padY("gnd")],), w);

board.wire(path(IC2.pad("gnd"),
                [C1.padX("1"), IC2.padY("gnd")],
                C1.pad("1"),), w);

board.wire(path(IC2.pad("out"),
                [C1.padX("2"), IC2.padY("out")],
                C1.pad("2"),), w);

board.wire(path(J1.pad("V"),
                [J1.padX("V"), J1.padY("V")-.12],
                [C1.padX("2"), J1.padY("V")-.12],
                C1.pad("2"),), w);

board.wire(path(R1.pad("1"),
                [R1.padX("1"), IC1.padY("VCC")],
                IC1.pad("VCC"),), w);

board.wire(path(R1.pad("2"),
                [J1.padX("RST"), R1.padY("2")],
                J1.pad("RST"),), w);

board.wire(path(J1.pad("GND"),
                [J1.padX("GND"), J1.padY("GND")-.08],
                [J3.padX("GND")+.02, J1.padY("GND")-.08],
                [J3.padX("GND")+.02, J3.padY("GND")],
                J3.pad("GND"),), w);

board.wire(path(J1.pad("V"),
                [J1.padX("V"), J1.padY("V")-.12],
                [J3.padX("VCC")-.02, J1.padY("V")-.12],
                [J3.padX("VCC")-.02, J3.padY("VCC")],
                J3.pad("VCC"),), w);

board.wire(path(J3.pad("VCC"),
                [J3.padX("VCC")-.08, J3.padY("VCC")],
                [J3.padX("VCC")-.08, J3.padY("MISO")-.05],
                [J3.padX("MISO")+.08, J3.padY("MISO")-.05],
                [J3.padX("MISO")+.08, R1.posY],
                R1.pad("1"),), w);

board.wire(path(IC1.pad("PB2"),
                [IC1.padX("PB2")-.08, IC1.padY("PB2")],
                [IC1.padX("PB2")-.08, J3.padY("CE")],
                J3.pad("CE"),), w);

board.wire(path(IC1.pad("PA7"),
                [IC1.padX("PA7")-.12, IC1.padY("PA7")],
                [IC1.padX("PA7")-.12, J3.padY("CS")-.05],
                [J3.padX("CS"), J3.padY("CS")-.05],
                J3.pad("CS"),), w);
...
board.wire(path(IC1.pad("PB1"),
                [J3.padX("MOSI"), IC1.padY("PB1")],
                J3.pad("MOSI"),), w);

board.wire(path(J3.pad("MISO"),
                [J3.padX("MISO"), R1.posY+.06],
                [J2.padX("GND")+.08, R1.posY+.06],
                [J2.padX("GND")+.08, J2.padY("GND")-.05],
                [J2.padX("CTS")-.12, J2.padY("GND")-.05],
                [J2.padX("CTS")-.12, IC1.padY("PA0")],
                IC1.pad("PA0"),), w);

board.wire(path(J3.pad("IRQ"),
                [J3.padX("IRQ"), R1.posY+.1],
                [J2.padX("GND")+.12, R1.posY+.1],
                [J2.padX("GND")+.12, J2.padY("CTS")-.05],
                [J2.padX("CTS")-.08, J2.padY("CTS")-.05],
                [J2.padX("CTS")-.08, IC1.padY("PA1")],
                IC1.pad("PA1"),), w);

board.wire(path(C2.pad("1"),
                [J3.padX("VCC")-.02, C2.padY("1")],
                [J3.padX("VCC")-.02, J3.padY("VCC")],
                J3.pad("VCC"),), w);

board.wire(path(C2.pad("2"),
                [J3.padX("GND")+.02, C2.padY("2")],
                [J3.padX("GND")+.02, J3.padY("GND")],
                J3.pad("GND"),), w);

board.wire(path(C3.pad("1"),
                [J3.padX("VCC")-.02, C3.padY("1")],
                [J3.padX("VCC")-.02, J3.padY("VCC")],
                J3.pad("VCC"),), w);

board.wire(path(C3.pad("2"),
                [J3.padX("GND")+.02, C3.padY("2")],
                [J3.padX("GND")+.02, J3.padY("GND")],
                J3.pad("GND"),), w);
