...
const Hall_SOT23 = footprint({"Vcc":{"shape":"M -0.02,0.012L 0.02,0.012L 0.02,-0.012L -0.02,-0.012L -0.02,0.012","pos":[-0.045,0.0375],"layers":["F.Cu","F.Mask"],"index":1},"out":{"shape":"M -0.02,0.012L 0.02,0.012L 0.02,-0.012L -0.02,-0.012L -0.02,0.012","pos":[-0.045,-0.0375],"layers":["F.Cu","F.Mask"],"index":2},"gnd":{"shape":"M -0.02,0.012L 0.02,0.012L 0.02,-0.012L -0.02,-0.012L -0.02,0.012","pos":[0.045,0],"layers":["F.Cu","F.Mask"],"index":3}});
...
/* -- ADD_COMPONENTS -- */
let IC1 = board.add(SAMD11C, {translate: pt(x+.5, y+.41), id: 'IC1\nD11C'});
...
let C1 = board.add(C_1206, {translate: pt(IC2.posX-.04, IC2.posY-.15), id: 'C1 1uF'});
let IC3 = board.add(Hall_SOT23, {translate: pt(IC2.posX-.13, IC2.posY), rotate: -90, id: 'IC3\n1324'});
let R1 = board.add(R_1206, {translate: pt(C1.posX, C1.posY-.1), id: 'R1 4.99k'});
let R2 = board.add(R_1206, {translate: pt(R1.posX, R1.posY-.1), id: 'R2 10k'});
...
board.wire(path(IC2.pad("out"),
                [IC1.padX("RST")-.09, IC2.padY("out")],
                [IC1.padX("RST")-.09, J1.padY("RST")-.05],
                [IC1.padX("VDD")+.06, J1.padY("RST")-.05],
                [IC1.padX("VDD")+.06, IC1.padY("VDD")],
                IC1.pad("VDD"),), w);
...
board.wire(path(IC2.pad("gnd"),
                [C1.posX, IC2.padY("gnd")],
                [C1.posX, C1.posY],
                C1.pad("1"),), w);

board.wire(path(IC2.pad("out"),
                [IC1.padX("RST")-.09, IC2.padY("out")],
                [IC1.padX("RST")-.09, C1.posY],
                C1.pad("2"),), w);

board.wire(path(IC2.pad("gnd"),
                [C1.posX, IC2.padY("gnd")],
                [C1.posX, J1.padY("RST")-.11],
                [IC1.padX("A04")+.12, J1.padY("RST")-.11],
                [IC1.padX("A04")+.12, J2.padY("5V")-.11],
                [J2.padX("GND"), J2.padY("5V")-.11],
                J2.pad("GND"),), w);

board.wire(path(IC3.pad("Vcc"),
                IC2.pad("in"),), w);
...
board.wire(path(R2.pad("2"),
                [R2.padX("2"), J1.padY("RST")-.08],
                [IC1.padX("A02")+.09, J1.padY("RST")-.08],
                [IC1.padX("A02")+.09, IC1.padY("A02")],
                IC1.pad("A02"),), w);
