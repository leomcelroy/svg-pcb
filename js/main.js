...
`);function q(e){return O`
	...
	`}var pe=e=>e.length===4?`rgba(${e.map((r,t)=>t<3?Math.round(r*255):r).join(",")})`:"rgba(255, 255, 255, 1)",X=(e,r)=>P`
	<path
		d="${e}"
		fill-rule="nonzero"
		fill="${typeof r=="string"?r:pe(r)}"/>
`,he=e=>e.reduce((r,t,o)=>`${r} ${o===0?"M":"L"} ${t.join(",")}`,""),fe=(e,r)=>{let t=[[e.lt.x,(e.lt.y+e.lb.y)/2],[e.rt.x,(e.rt.y+e.rb.y)/2]],o=[[(e.lt.x+e.rt.x)/2,e.lt.y],[(e.lb.x+e.rb.x)/2,e.lb.y]],n=[[e.lt.x,0],[e.rt.x,0]],i=[[0,e.lt.y],[0,e.lb.y]],s=[e.lt.x,e.rt.x],m=Math.abs(s[1]-s[0]),l=[e.lb.y,e.lt.y],c=Math.abs(l[1]-l[0]);function h(_,u){return Math.log(u)/Math.log(_)}let a=Math.round(h(5,Math.max(m,c))),d=r,p=(_,u)=>{let j=[],k=u*Math.ceil(_[0]/u)-u;for(;k<_[1]+u;)k=k+u,j.push(k);return j},y=_=>[[e.lt.x,_],[e.rt.x,_]],w=_=>[[_,e.lt.y],[_,e.lb.y]],f=_=>u=>P`<path stroke="black" vector-effect="non-scaling-stroke" stroke-width="${_}" d="${he(u)}"/>`,b=p(l,d).map(y).map(f(.2)),x=p(s,d).map(w).map(f(.2));return P`
	...
	`},me=e=>{var o;let r=e.shapes.map(n=>Array.isArray(n.d)?n.d.map(i=>X(i,n.color)):X(n.d,n.color)).flat(),t=(o=e.panZoomParams)==null?void 0:o.corners();return P`
...
`);import{render as qe}from"https://cdn.skypack.dev/lit-html";import ye from"https://cdn.skypack.dev/esprima";import"https://cdn.skypack.dev/astring";import{walk as E}from"https://cdn.skypack.dev/esprima-walk";function _e(e){let r=s=>s.includes("return kicadToObj("),o=e.codemirror.view.state.doc.toString().split(`
`),n=0,i=0;for(;;){let s=o[n];if(!s||(i+=s.length,n>o.length)||o[n]==="`)})()"&&!r(o[n+1]))break;n++}e.codemirror.foldRange(0,i+n)}function U(e,r){let t=document.querySelector("svg"),o=!1,n,i=0,s=0,m;r("mousedown",".translate-handle-trigger",l=>{o=!0,e.transforming=!0,i=0,s=0,n=t.panZoomParams.svgPoint({x:l.offsetX,y:l.offsetY}),m=l.target.dataset.index;let h=e.codemirror.view.state.doc.toString(),a=`()=>{${h}}`,d=ye.parseScript(a,{range:!0,comment:!0});console.log(d);let p=d.body[0].expression.body.body;console.log(p);let y=[];E(d,u=>{try{u.callee.type==="MemberExpression"&&u.callee.property.name==="add"&&y.push(u.arguments[1])}catch(j){}});let w=y.sort((u,j)=>u.range[0]-j.range[0]),f=u=>u.includes(".")?u.split(".")[1].length:u.length,b=(u,j)=>Math.round(u/j)*j,x=(u,j)=>Math.round(u*10**j)/10**j,_=u=>/[0-9]/i.test(u)||u===".";e.transformUpdate=(u,j)=>{let k=[];w[m].properties.forEach(A=>{if(A.key.name!=="translate")return;let[ae,le]=A.value.elements,M=!1;E(ae,g=>{if(!M&&g.type==="Literal"&&typeof g.value=="number"){g.ogValue||(g.ogValue=g.value),g.ogRaw||(g.ogRaw=g.raw);let $=g.ogValue+u;k.push({from:g.range[0]-5,to:g.range[1]-5,insert:`${e.gridSize===0?x($,f(g.ogRaw)):x(b($,e.gridSize),8)}`}),M=!0}});let L=!1;E(le,g=>{if(!L&&g.type==="Literal"&&typeof g.value=="number"){g.ogValue||(g.ogValue=g.value),g.ogRaw||(g.ogRaw=g.raw);let $=g.ogValue+j;k.push({from:g.range[0]-5,to:g.range[1]-5,insert:`${e.gridSize===0?x($,f(g.ogRaw)):x(b($,e.gridSize),8)}`}),L=!0}});let ce=e.codemirror.view.state.doc.toString();e.codemirror.view.dispatch({changes:{from:0,to:ce.length,insert:h}}),e.codemirror.view.dispatch({changes:k})}),_e(e)}}),r("mousemove","",l=>{if(!o)return;let h=t.panZoomParams.svgPoint({x:l.offsetX,y:l.offsetY}),a=h.x-n.x,d=h.y-n.y;dispatch("TRANSLATE",{x:a,y:d,index:m}),i=a,s=d}),r("mouseup","",l=>{o=!1,e.transforming=!1}),r("mouseleave","",l=>{o=!1,e.transforming=!1})}function F(e,r){let t=!1;r("mousedown","#vertical-bar",o=>{t=!0}),r("mousemove","",o=>{if(!t)return;let n=o.clientX/window.innerWidth*100;if(n===0)return;let i=1,s=99;n<i&&(n=i),n>s&&(n=s),document.documentElement.style.setProperty("--vertical-bar",`${n}%`),pauseEvent(o)}),r("mouseup","",o=>{t=!1})}function V(e,r){let t=!1,o=1,n=0,i=0,s={x:0,y:0};function m(a){a.style.transformOrigin=`${0}px ${0}px`,a.style.transform="translate("+n+"px, "+i+"px) scale("+o+")",e.gridSize>0&&dispatch("RENDER")}function l({x:a,y:d}){let p=(a-n)/o,y=(d-i)/o;return{x:p,y}}r("mousedown","",a=>{a.shiftKey||(t=!0,s={x:a.offsetX-n,y:a.offsetY-i},a.detail===2&&console.log(a.offsetX,a.offsetY,l({x:a.offsetX,y:a.offsetY})))}),r("mousemove","",a=>{if(!t||e.transforming)return;n=a.offsetX-s.x,i=a.offsetY-s.y;let d=document.querySelectorAll(".transform-group");for(let p of d)m(p)}),r("mouseup","",a=>{t=!1}),r("wheel","",a=>{let d=(a.offsetX-n)/o,p=(a.offsetY-i)/o;Math.sign(a.deltaY)<0?o*=1.03:o/=1.03,n=a.offsetX-d*o,i=a.offsetY-p*o;let y=document.querySelectorAll(".transform-group");for(let w of y)m(w);a.preventDefault()});function c(a){console.log("set scale x y");let p=document.querySelector("svg").getBoundingClientRect(),y=a.x[1]-a.x[0],w=a.y[1]-a.y[0],f=p.width/y,b=p.height/w,x=Math.min(f,b)*.9;o=x;let _={x:(a.x[0]+a.x[1])/2*x-p.width/2,y:(a.y[0]+a.y[1])/2*x-p.height/2};n=-_.x,i=-_.y;let u=document.querySelectorAll(".transform-group");for(let j of u)m(j)}function h(){let a=document.querySelector("svg");if(a===null)return null;let{left:d,right:p,bottom:y,top:w,width:f,height:b}=a.getBoundingClientRect(),x=l({x:f,y:b}),_=l({x:0,y:b}),u=l({x:f,y:0}),j=l({x:0,y:0});return{rt:x,lt:_,rb:u,lb:j}}return{scale:()=>o,x:()=>n,y:()=>i,corners:h,svgPoint:l,setScaleXY:c}}var z=0;function be(e){var r=new FileReader;r.readAsText(e),r.onloadend=t=>{let o=r.result;dispatch("UPLOAD_COMP",{text:o,name:`component${z}`}),z++}}function ve(e){var r=new FileReader;r.readAsText(e),r.onloadend=t=>{let o=r.result;dispatch("UPLOAD_JS",{text:o})}}function we(e,r=[]){let t=e[0],o=t.name.split("."),n=o[0],i=o[o.length-1];if(i==="kicad_mod")be(t);else if(i==="js")ve(t);else throw Error("Unknown extension:",i)}function H(e,r){r("drop","",function(t){let n=t.dataTransfer.files;we(n),pauseEvent(t)}),r("dragover","",function(t){pauseEvent(t)})}function Y(e,r){let t=null,o=null,n=document.querySelector("svg");r("mousedown","",s=>{!s.shiftKey||(t=n.panZoomParams.svgPoint({x:s.offsetX,y:s.offsetY}))}),r("mousemove","",s=>{document.body.classList.add("no-select"),!!s.shiftKey&&t!==null&&(o=n.panZoomParams.svgPoint({x:s.offsetX,y:s.offsetY}),e.selectBox.start=t,e.selectBox.end=o,dispatch("RENDER"))});function i(s,m){let{start:l,end:c}=m;return s.x>l.x&&s.x<c.x&&s.y>l.y&&s.y<c.y||s.x>l.x&&s.x<c.x&&s.y<l.y&&s.y>c.y||s.x<l.x&&s.x>c.x&&s.y>l.y&&s.y<c.y||s.x<l.x&&s.x>c.x&&s.y<l.y&&s.y>c.y}r("mouseup","",s=>{!s.shiftKey||(document.body.classList.remove("no-select"),t=null,o=null,e.selectBox.start=t,e.selectBox.end=o,dispatch("RENDER"))})}var Z=(e,r=!1)=>/[0-9]/i.test(e)||e==="."||r&&e==="-";function W(e,r){let t=!1,o,n,i,s,m,l;r("mousedown",".ͼb",c=>{let a=document.querySelector("code-mirror").view.state,d=a.doc,p=a.selection.main.head,y=d.lineAt(p),{from:w,to:f,text:b}=d.lineAt(p),x=p,_=p;for(;x>w&&Z(b[x-w-1],!0);)x--;for(;_<f&&Z(b[_-w]);)_++;l=b.slice(x-w,_-w),o=Number(l),t=!0,n=x,i=_,m=l.includes("."),s=l.includes(".")?l.split(".")[1].length:1}),r("mousemove","",c=>{if(!t)return;let h=document.querySelector("code-mirror"),a=0>c.movementX?1:-1,d=`${o}`;if(m){let w=Math.round(o*10**s)+c.movementX;w=Math.round(w)/10**s,o=w}else o+=c.movementX;let p=`${o}`;h.view.dispatch({changes:{from:n,to:n+l.length,insert:p}}),l=p,dispatch("RUN"),pauseEvent(c)}),r("mouseup","",c=>{t=!1})}function xe(e){return e.stopPropagation&&e.stopPropagation(),e.preventDefault&&e.preventDefault(),e.cancelBubble=!0,e.returnValue=!1,!1}window.pauseEvent=xe;var G=e=>e.composedPath()[0],je=(e,r)=>G(e).matches(r),K=e=>(r,t,o)=>{e.addEventListener(r,n=>{n.trigger=G(n),(t===""||je(n,t))&&o(n)})};function J(e){let r=document.querySelector("svg"),t=K(r);r.panZoomParams=V(e,t),e.panZoomParams=r.panZoomParams,Y(e,t),U(e,t);let o=document.querySelector("body"),n=K(o);H(e,n),W(e,n),F(e,n),n("keydown","",i=>{let s=event.code;s==="Enter"&&event.shiftKey?(event.preventDefault(),dispatch("RUN",{save:!0})):s==="KeyT"&&event.shiftKey})}import{Turtle as v}from"https://leomcelroy.com/gram-js/exports.js";function Se(e){return new v().arc(360,e).originate()}function Te(e,r){return new v().forward(e).right(90).forward(r).right(90).repeat(1).originate()}v.prototype.circle=Se;v.prototype.rectangle=Te;var ke=([e,r],[t,o])=>Math.sqrt((t-e)**2+(o-r)**2),Pe=(e,r)=>ke(e,r)<1e-6,Q=(e,r)=>({F:{pos:[0,0],shape:new v().circle(r).getPathData(),layers:["F.Cu"],index:1},B:{pos:[0,0],shape:new v().circle(r).getPathData(),layers:["B.Cu"],index:2},drill:{pos:[0,0],shape:new v().circle(e).getPathData(),layers:["drill"]}}),ee=(e,r)=>{let t=e[0],o=new v;o.booleanScale=2e3,o.goto(t,!1);for(let n of e.slice(1))Pe(n,t)||(o.goto(n),t=n);return o.offset(r/2)},$e=([e,r],[t,o])=>[e+t,r+o];var Re=([e,r],t)=>[e*Math.cos(t)-r*Math.sin(t),r*Math.cos(t)+e*Math.sin(t)],re=class{constructor({pads:r,layers:t}){this.pads=r,this.layers=t}pad(r){return this.pads[r]}padX(r){return this.pads[r][0]}padY(r){return this.pads[r][1]}get pos(){return this.pads.center}get posX(){return this.pads.center[0]}get posY(){return this.pads.center[1]}};function te(e,r={}){let t=r.translate||[0,0],o=r.rotate||0,n=r.padLabelSize||2e-4,i=r.componentLabelSize||3e-4,[s,m]=t,l=o*Math.PI/180,c={},h=[],a={};for(let d in e){let{pos:p,shape:y,layers:w}=e[d];y=typeof y=="string"?new v().bezier(y):y.copy();let f=$e(Re(p,l),t);if(c[d]=f,y.translate(f).rotate(o,f),!d.includes("_drill")){let b=new v().text(d).scale(n).originate().translate(f);h.push(b)}w.forEach(b=>{b in a?a[b]=a[b].group(y):a[b]=y})}return c.center=t,a.padLabels=h.reduce((d,p)=>d.group(p),new v),new re({pads:c,layers:a})}var C=class{constructor(){this.layers={},this.components=[]}add(r,t={}){let o=t.name||"",n={translate:t.translate||[0,0],rotate:t.rotate||0,padLabelSize:t.padLabelSize||3e-4,componentLabelSize:t.componentLabelSize||4e-4},i=te(r,n);for(let s in i.layers)this.addShape(s,i.layers[s]);if(o!==""&&!o.includes("_drill")){let s=new v().text(o).scale(n.componentLabelSize).originate().translate(n.translate);this.addShape("componentLabels",s)}return this.components.push(i),i}addShape(r,t){return t instanceof v?(r in this.layers?this.layers[r]=this.layers[r].group(t):this.layers[r]=t,this.layers[r]):console.error("Shape isn't Turtle.")}subtractShape(r,t){return t instanceof v?(r in this.layers?this.layers[r]=this.layers[r].difference(t):this.layers[r]=new v,this.layers[r]):console.error("Shape isn't Turtle.")}getLayer(r,t=!1){let o=r.includes("Labels");return t=!r.includes("Labels"),this.layers[r]?t?this.layers[r].flatten().getPathData(o):this.layers[r].getPathData(o):""}wire(r,t,o="F.Cu"){this.addShape(o,ee(r,t))}};function S(e){this._line=this._col=this._pos=0,this._stream=e}S.not_whitespace_or_end=/^(\S|$)/;S.space_quote_paren_escaped_or_end=/^(\s|\\|"|'|`|,|\(|\)|$)/;S.string_or_escaped_or_end=/^(\\|"|$)/;S.string_delimiters=/["]/;S.quotes=/['`,]/;S.quotes_map={"'":"quote","`":"quasiquote",",":"unquote"};S.prototype={peek:Ce,consume:De,until:Ae,error:Ee,string:Me,atom:Le,quoted:Ie,expr:Ne,list:Be};function oe(e){var r=new S(e),t=r.expr();return t instanceof Error?t:r.peek()!=""?r.error("Superfluous characters after expression: `"+r.peek()+"`"):t}function Ee(e){var r=new Error("Syntax error: "+e);return r.line=this._line+1,r.col=this._col+1,r}function Ce(){return this._stream.length==this._pos?"":this._stream[this._pos]}function De(){if(this._stream.length==this._pos)return"";var e=this._stream[this._pos];return this._pos+=1,e=="\r"?(this.peek()==`
`&&(this._pos+=1,e+=`
...
`):t=="f"?(this.consume(),r+="\f"):t=="b"?(this.consume(),r+="\b"):r+=this.consume();continue}r+=this.consume()}return new String(r)}function Le(){if(S.string_delimiters.test(this.peek()))return this.string();for(var e="";;){e+=this.until(S.space_quote_paren_escaped_or_end);var r=this.peek();if(r=="\\"){this.consume(),e+=this.consume();continue}break}return e}function Ie(){var e=this.consume(),r=S.quotes_map[e];r=="unquote"&&this.peek()=="@"&&(this.consume(),r="unquote-splicing",e=",@"),this.until(S.not_whitespace_or_end);var t=this.expr();return t instanceof Error?t:t===""?this.error("Unexpected `"+this.peek()+"` after `"+e+"`"):[r,t]}function Ne(){if(this.until(S.not_whitespace_or_end),S.quotes.test(this.peek()))return this.quoted();var e=this.peek()=="("?this.list():this.atom();return this.until(S.not_whitespace_or_end),e}function Be(){if(this.peek()!="(")return this.error("Expected `(` - saw `"+this.peek()+"` instead.");this.consume();var e=[],r=this.expr();if(r instanceof Error)return r;if(r!=="")for(e.push(r);(r=this.expr())!=="";){if(r instanceof Error)return r;e.push(r)}return this.peek()!=")"?this.error("Expected `)` - saw: `"+this.peek()+"`"):(this.consume(),e)}var Oe=e=>e.reduce((r,t)=>{let o=t.split(".");return o.length===0?r:o[0]!=="*"?[...r,t]:[...r,`F.${o[1]}`,`B.${o[1]}`]},[]);function se(e){let r=oe(e),t=1/25.4,o={};for(let i of r){let s=i[0]==="pad",m=i[2]==="smd",l=i[2]==="thru_hole",c=i[3];if(s&&(m||l)){let h=i[1],a=i[4].slice(1).map(f=>Number(f)*t);a[1]=-a[1];let d=i[i.length-1];d=d?d.slice(1):[],d=Oe(d);let p=i[5].slice(1).map(f=>Number(f)*t),y=c==="rect"?new v().rectangle(...p):new v().circle(p[0]);if(o[h]===void 0?o[h]=[{pos:a,shape:y,layers:d}]:o[h].push({pos:a,shape:y,layers:d}),i[i.length-2]?i[i.length-2][0]==="drill":!1){let f=Number(i[i.length-2][1])/25.4,b={pos:a,shape:new v().circle(f),layers:["drill"]};o[`${h}_drill`]===void 0?o[`${h}_drill`]=[b]:o[`${h}_drill`].push(b)}}}return Object.entries(o).reduce((i,s)=>{let[m,l]=s;return l.length===1?i[m]=l[0]:l.forEach((c,h)=>{i[`${m}_${h+1}`]=c}),i},{})}var D={codemirror:void 0,storedPCB:void 0,transforming:!1,transformUpdate:()=>{},selectBox:{},shapes:[],limits:{x:[0,1],y:[0,1]},mm_per_unit:25.4,grid:!0,gridSize:.05,viewHandles:!0,panZoomParams:void 0},ne=class extends C{constructor(){super();D.storedPCB=this}},ie={kicadToObj:se,PCB:ne,via:Q,Turtle:v};async function Xe(e,r){let o=await(await fetch(e,{mode:"cors"})).text();r.codemirror.view.dispatch({changes:{from:0,insert:o}});let n=c=>c.includes("return kicadToObj("),s=r.codemirror.view.state.doc.toString().split(`
`),m=0,l=0;for(;;){let c=s[m];if(!c||(l+=c.length,m>s.length)||s[m]==="`)})()"&&!n(s[m+1]))break;m++}r.codemirror.foldRange(0,l+m),T("RUN"),document.querySelector(".center-button").click()}var Ue={INIT(e,r){T("RENDER"),r.codemirror=document.querySelector("#code-editor"),J(r);let t=new URL(window.location.href),o=window.location.search,n=new URLSearchParams(o).get("code"),i=new URLSearchParams(o).get("file");if(!n)if(i){let s=i;i.startsWith("http")||(s=`examples/${i}`),Xe(s,r)}else{let s=window.localStorage.getItem("svg-pcb");r.codemirror.view.dispatch({changes:{from:0,insert:s!=null?s:""}}),T("RUN"),document.querySelector(".center-button").click()}},RUN({save:e=!1},r){let t=r.codemirror.view.state.doc.toString(),n=new Function(...Object.keys(ie),t)(...Object.values(ie)),{shapes:i,limits:s,mm_per_unit:m}=typeof n=="string"?JSON.parse(n):n;r.shapes=i,r.limits=s,r.mm_per_unit=m,e&&window.localStorage.setItem("svg-pcb",t),T("RENDER")},UPLOAD_COMP({text:e,name:r},t){e=e.replaceAll("$",""),e=`const ${r} = (() => { return kicadToObj(
\`${e}\`)})()
...
`,t.codemirror.view.dispatch({changes:{from:0,insert:e}}),T("RENDER")},TRANSLATE({x:e,y:r,index:t},o){o.transformUpdate(e,r),T("RUN")},RENDER(){qe(q(D),document.getElementById("root"))}};function T(e,r={}){let t=Ue[e];t?t(r,D):console.log("Action not recongnized:",e)}window.dispatch=T;window.addEventListener("load",()=>{T("INIT")});
